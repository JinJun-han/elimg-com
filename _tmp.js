...
const VOCAB_SHIPYARD = [
  ...
  {kor:"오늘 일을 못 하겠어요.",eng:"I can't work today.",sit:"근무 불가"},
...
const GRAMMAR = [
  {title:"~아/어서 (Because/So)",eng:"~아/어서 (Reason/Cause)",
   ...
   examples:[
    ...
    {q:"왜 못 일해요?",a:"열이 나서 못 일해요.",eng:"I can't work because I have a fever.",note:"나다→나서"},
    ...
    {q:"왜 손을 못 써요?",a:"다쳐서 못 써요.",eng:"I can't use it because I got hurt.",note:"다치다→다쳐서"},
   ]},
  {title:"~(으)ㄹ 때 (When)",eng:"~(으)ㄹ 때 (When/At the time)",
   ...
   examples:[
    {q:"언제 약을 먹어요?",a:"아플 때 약을 먹어요.",eng:"I take medicine when I'm sick.",note:"아프+ㄹ 때"},
  ...
  {title:"~지 마세요 (Don't)",eng:"~지 마세요 (Please don't)",
   ...
   examples:[
    {q:"",a:"아프면 무리하지 마세요.",eng:"Don't overdo it if you're sick.",note:"무리하+지 마세요"},
    {q:"",a:"약을 빼먹지 마세요.",eng:"Don't skip your medicine.",note:"빼먹+지 마세요"},
    {q:"",a:"아픈데 일하지 마세요.",eng:"Don't work when you're sick.",note:"일하+지 마세요"},
    {q:"",a:"찬 음식을 먹지 마세요.",eng:"Don't eat cold food.",note:"먹+지 마세요"},
    {q:"",a:"걱정하지 마세요.",eng:"Don't worry.",note:"걱정하+지 마세요"},
   ]},
];
...
const DIALOGUES = [
  {title:"의무실에서",eng:"At the Infirmary",lines:[
    ...
    {sp:"의사",text:"감기인 것 같아요. 약을 드릴게요.",eng:"It seems like a cold. I'll give you medicine.",side:"L"},
    {sp:"라민",text:"오늘 일을 해도 돼요?",eng:"Can I work today?",side:"R"},
    {sp:"의사",text:"오늘은 쉬세요. 무리하지 마세요.",eng:"Rest today. Don't overdo it.",side:"L"},
  ]},
  {title:"동료가 다쳤을 때",eng:"When a Colleague Gets Hurt",lines:[
    {sp:"후엔",role:"배관공",text:"안젤라 씨! 괜찮아요?!",eng:"Angela! Are you okay?!",side:"R"},
    {sp:"안젤라",role:"전기공",text:"손을 다쳤어요... 피가 나요.",eng:"I hurt my hand... It's bleeding.",side:"L"},
    {sp:"후엔",text:"빨리 의무실에 가요! 제가 도와줄게요.",eng:"Let's go to the infirmary quickly! I'll help you.",side:"R"},
    {sp:"안젤라",text:"고마워요... 많이 아파요.",eng:"Thank you... It hurts a lot.",side:"L"},
    {sp:"후엔",text:"걱정하지 마세요. 반장님한테 보고할게요.",eng:"Don't worry. I'll report to the team leader.",side:"R"},
...
const QUIZ = [
  ...
  {q:"'머리가 아파요'의 뜻은?",o:["I have a headache","I have a stomachache","I'm dizzy","I'm tired"],a:0},
  {q:"'감기'의 뜻은?",o:["cold (illness)","headache","fever","cough"],a:0},
  {q:"'열이 나요'의 뜻은?",o:["I have a fever","I'm cold","I'm hot","I'm hungry"],a:0},
...
const HANGUL_PRACTICE = [
  ...
  {char:"세 시",rom:"se si",name:"3 o'clock"},{char:"네 번",rom:"ne beon",name:"4 times"},
