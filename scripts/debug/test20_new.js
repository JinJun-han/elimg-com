...
const VOCAB_DREAM = [
  ...
  {kor:"목표",pron:"mok-pyo",eng:"goal"},
  {kor:"희망",pron:"hui-mang",eng:"hope"},
  {kor:"성공",pron:"seong-gong",eng:"success"},
  {kor:"노력",pron:"no-ryeok",eng:"effort/hard work"},
  {kor:"도전",pron:"do-jeon",eng:"challenge"},
  {kor:"경험",pron:"gyeong-heom",eng:"experience"},
  {kor:"실력",pron:"sil-ryeok",eng:"skill/ability"},
  {kor:"자격증",pron:"ja-gyeok-jeung",eng:"certificate/license"},
  {kor:"승진",pron:"seung-jin",eng:"promotion"},
  {kor:"귀국",pron:"gwi-guk",eng:"return to home country"},
  {kor:"사업",pron:"sa-eop",eng:"business"},
  {kor:"저축",pron:"jeo-chuk",eng:"savings"},
  {kor:"가족",pron:"ga-jok",eng:"family"},
  {kor:"행복",pron:"haeng-bok",eng:"happiness"},
  {kor:"감사",pron:"gam-sa",eng:"gratitude/thank you"},
];

const VOCAB_SHIPYARD = [
  {kor:"꿈이 뭐예요?",eng:"What's your dream?",sit:"꿈 질문"},
  {kor:"저는 한국에서 더 일하고 싶어요.",eng:"I want to work more in Korea.",sit:"미래 계획"},
  {kor:"자격증을 따려고 해요.",eng:"I'm planning to get a certificate.",sit:"목표"},
  {kor:"승진하게 됐어요.",eng:"I got promoted.",sit:"성공"},
  {kor:"한국어 실력이 많이 늘었어요.",eng:"My Korean has improved a lot.",sit:"성장"},
  {kor:"2년 후에 한국에서 사업을 시작할 거예요.",eng:"I'll start a business in Korea in 2 years.",sit:"미래 목표"},
  {kor:"가족이 저를 응원해요.",eng:"My family supports me.",sit:"응원"},
  {kor:"저축해서 집을 사고 싶어요.",eng:"I want to save and buy a house.",sit:"꿈"},
  {kor:"한화오션에서 일한 지 1년이 됐어요.",eng:"It's been 1 year working at Hanwha Ocean.",sit:"경험"},
  {kor:"한국 생활이 정말 좋아요.",eng:"Korean life is really good.",sit:"만족"},
  {kor:"도전할 준비가 돼 있어요.",eng:"I'm ready for challenges.",sit:"태도"},
  {kor:"꿈을 이루려고 노력하고 있어요.",eng:"I'm working hard to achieve my dreams.",sit:"노력"},
  {kor:"한국에서 계획한 일들이 성공했어요.",eng:"My planned activities in Korea succeeded.",sit:"성공"},
  {kor:"20과를 마쳤어요!",eng:"I completed Lesson 20!",sit:"졸업"},
  {kor:"처음보다 훨씬 잘해요!",eng:"I'm doing much better than at first!",sit:"진급"},
  {kor:"감사합니다!",eng:"Thank you!",sit:"감사"},
];

const VOCAB_FUTURE = [
  {kor:"기술",pron:"gi-sul",eng:"technology/skill"},
  {kor:"자격증시험",pron:"ja-gyeok-jeung-si-heom",eng:"certification exam"},
  {kor:"기능사",pron:"gi-neung-sa",eng:"skilled worker"},
  {kor:"기사",pron:"gi-sa",eng:"engineer"},
  {kor:"산업기사",pron:"san-eop-gi-sa",eng:"industrial engineer"},
  {kor:"기술자",pron:"gi-sul-ja",eng:"technician"},
  {kor:"용접 자격증",pron:"yong-jeop ja-gyeok-jeung",eng:"welding certificate"},
  {kor:"배관 기술",pron:"bae-gwan gi-sul",eng:"plumbing skill"},
  {kor:"도장 기술",pron:"do-jang gi-sul",eng:"painting skill"},
  {kor:"전기 기술",pron:"jeon-gi gi-sul",eng:"electrical skill"},
  {kor:"안전보건",pron:"an-jeon-bo-geon",eng:"occupational safety & health"},
  {kor:"근로계약",pron:"geun-ro-gye-yak",eng:"employment contract"},
  {kor:"상여금",pron:"sang-yeo-geum",eng:"bonus"},
  {kor:"퇴직금",pron:"toe-jik-geum",eng:"severance pay"},
  {kor:"연금",pron:"yeon-geum",eng:"pension"},
  {kor:"건강보험",pron:"geon-gang-bo-heom",eng:"health insurance"},
  {kor:"장기근속",pron:"jang-gi-geun-sok",eng:"long-term service"},
  {kor:"국제화",pron:"guk-je-hwa",eng:"globalization"},
  {kor:"우수사원",pron:"u-su-sa-won",eng:"excellent employee"},
  {kor:"팀 리더",pron:"tim ri-deo",eng:"team leader"},
  {kor:"사원",pron:"sa-won",eng:"employee"},
  {kor:"대리",pron:"dae-ri",eng:"assistant manager"},
  {kor:"과장",pron:"gwa-jang",eng:"manager"},
  {kor:"차장",pron:"cha-jang",eng:"senior manager"},
  {kor:"부장",pron:"bu-jang",eng:"department head"},
  {kor:"임원",pron:"im-won",eng:"executive"},
  {kor:"경력",pron:"gyeong-ryeok",eng:"career/experience"},
  {kor:"경험",pron:"gyeong-heom",eng:"experience"},
  {kor:"스킬",pron:"seu-kil",eng:"skill"},
  {kor:"역량",pron:"yeok-ryang",eng:"capability"},
  {kor:"성장",pron:"seong-jang",eng:"growth"},
  {kor:"발전",pron:"bal-jeon",eng:"development"},
  {kor:"진로",pron:"jin-ro",eng:"career path"},
  {kor:"포부",pron:"po-bu",eng:"aspiration"},
  {kor:"비전",pron:"bi-jeon",eng:"vision"},
  {kor:"목적",pron:"mok-jeok",eng:"objective"},
];

const VOCAB_SHIPYARD_NOUNS = [
  {kor:"AI",eng:"Artificial Intelligence"},
  {kor:"로봇",pron:"ro-bot",eng:"robot"},
  {kor:"우주항공",eng:"aerospace/space industry"},
  {kor:"자율주행",eng:"autonomous driving"},
  {kor:"수소경제",eng:"hydrogen economy"},
  {kor:"K-조선",eng:"Korean shipbuilding"},
  {kor:"한화오션비전",eng:"Hanwha Ocean Vision"},
  {kor:"스마트조선소",eng:"smart shipyard"},
  {kor:"디지털화",eng:"digitalization"},
  {kor:"4차산업혁명",eng:"4th industrial revolution"},
  {kor:"빅데이터",eng:"big data"},
  {kor:"클라우드",eng:"cloud"},
  {kor:"IoT",eng:"Internet of Things"},
  {kor:"사이버보안",eng:"cybersecurity"},
  {kor:"재정지원",eng:"financial support"},
  {kor:"교육훈련",eng:"training & education"},
  {kor:"복지",eng:"welfare"},
  {kor:"국방기술",eng:"defense technology"},
  {kor:"조선기술",eng:"shipbuilding technology"},
  {kor:"해양산업",eng:"marine industry"},
  {kor:"탄소중립",eng:"carbon neutrality"},
  {kor:"친환경",eng:"eco-friendly"},
  {kor:"지속가능성",eng:"sustainability"},
  {kor:"글로벌 회사",eng:"global company"},
  {kor:"국제무역",eng:"international trade"},
  {kor:"해외사업",eng:"overseas business"},
  {kor:"다문화",eng:"multiculturalism"},
  {kor:"소통",eng:"communication"},
  {kor:"팀워크",eng:"teamwork"},
  {kor:"리더십",eng:"leadership"},
];

const GRAMMAR = [
  {title:"~(으)려고 하다 (Intend to / Plan to)",eng:"~(으)려고 하다 (Intend to / Plan to)",
   desc:"장래의 계획이나 의도를 말할 때 '~(으)려고 하다'를 써요.",descEng:"Use ~(으)려고 하다 to express future plans or intentions.",
   rule:"동사 + (으)려고 하다",ruleEng:"Verb + (으)려고 하다",
   examples:[
    {q:"미래에 뭐 하려고 해요?",a:"사업을 시작하려고 해요.",eng:"I'm planning to start a business.",note:"시작하다+(으)려고 하다"},
    {q:"한국에서 뭐 하려고 해요?",a:"자격증을 따려고 해요.",eng:"I'm planning to get a certificate.",note:"따다+(으)려고 하다"},
    {q:"앞으로 뭐 하려고 해요?",a:"한국어를 더 배우려고 해요.",eng:"I'm planning to study more Korean.",note:"배우다+(으)려고 하다"},
    {q:"꿈이 뭐예요?",a:"집을 사려고 해요.",eng:"I'm planning to buy a house.",note:"사다+(으)려고 하다"},
    {q:"좋은 직원이 되려고 해요?",a:"네, 열심히 일하려고 해요.",eng:"Yes, I'm planning to work hard.",note:"일하다+(으)려고 하다"},
   ]},
  {title:"~게 되다 (Come to / Turn out)",eng:"~게 되다 (Come to / Turn out)",
   desc:"예상치 못한 결과나 변화를 말할 때 '~게 되다'를 써요.",descEng:"Use ~게 되다 to express unexpected results or changes.",
   rule:"형용사/동사 + 게 되다",ruleEng:"Adjective/Verb + 게 되다",
   examples:[
    {q:"한국이 좋아졌어요?",a:"네, 정말 좋아지게 됐어요.",eng:"Yes, it turned out to be really good.",note:"좋아지다+게 되다"},
    {q:"승진했어요?",a:"네, 승진하게 됐어요.",eng:"Yes, I got promoted.",note:"승진하다+게 되다"},
    {q:"한국어가 늘었어요?",a:"네, 실력이 많이 늘게 됐어요.",eng:"Yes, my skills improved a lot.",note:"늘다+게 되다"},
    {q:"마음이 변했어요?",a:"한국이 좋아져서 마음이 바뀌게 됐어요.",eng:"I started to like Korea so my mind changed.",note:"바뀌다+게 되다"},
    {q:"일이 잘 됐어요?",a:"도움을 받아서 일이 잘 되게 됐어요.",eng:"I got help so things worked out well.",note:"되다+게 되다"},
   ]},
  {title:"~(으)ㄹ 것이다 (Will / Going to)",eng:"~(으)ㄹ 것이다 (Will / Going to)",
   desc:"미래의 일을 예측하거나 다짐할 때 '~(으)ㄹ 것이다'를 써요.",descEng:"Use ~(으)ㄹ 것이다 to predict the future or make a promise.",
   rule:"동사/형용사 + (으)ㄹ 것이다",ruleEng:"Verb/Adjective + (으)ㄹ 것이다",
   examples:[
    {q:"2년 후에 뭐 할 거예요?",a:"사업을 할 거예요.",eng:"I will run a business.",note:"하다+(으)ㄹ 것이다"},
    {q:"한국에 남을 거예요?",a:"네, 한국에서 일할 거예요.",eng:"Yes, I will work in Korea.",note:"일하다+(으)ㄹ 것이다"},
    {q:"꿈을 이룰 거예요?",a:"네, 열심히 해서 이룰 거예요.",eng:"Yes, I will achieve it by working hard.",note:"이루다+(으)ㄹ 것이다"},
    {q:"앞으로 좋을 거예요?",a:"네, 좋을 것 같아요.",eng:"Yes, I think it will be good.",note:"좋다+(으)ㄹ 것이다"},
    {q:"성공할 거예요?",a:"노력하면 성공할 거예요.",eng:"If I work hard, I will succeed.",note:"성공하다+(으)ㄹ 것이다"},
   ]},
];

const DIALOGUES = [
  {title:"미래 꿈 이야기",eng:"Talking About Future Dreams",lines:[
    {sp:"라민",role:"용접공",text:"쑤안 씨, 미래의 꿈이 뭐예요?",eng:"Xuan, what's your future dream?",side:"R"},
    {sp:"쑤안",role:"배관공",text:"음, 2년 더 일한 후에 자격증을 따려고 해요.",eng:"I'm planning to get a certificate after 2 more years.",side:"L"},
    {sp:"라민",text:"그 다음에는요?",eng:"And then?",side:"R"},
    {sp:"쑤안",text:"그 다음에는 한국에서 작은 사업을 시작할 거예요.",eng:"Then I'll start a small business in Korea.",side:"L"},
    {sp:"라민",text:"정말 좋은 계획이네요! 저는 한국어를 더 공부해서 한화오션에서 리더가 되려고 해요.",eng:"That's a great plan! I'm planning to study Korean more and become a leader at Hanwha Ocean.",side:"R"},
    {sp:"쑤안",text:"우와, 멋있어요! 우리 함께 노력해요.",eng:"Wow, cool! Let's work hard together.",side:"L"},
  ]},
  {title:"자격증 따기",eng:"Getting Certified",lines:[
    {sp:"안젤라",role:"전기공",text:"준 씨, 최근에 자격증을 땠대요?",eng:"Jun, I heard you got a certificate recently?",side:"L"},
    {sp:"준",role:"도장공",text:"네! 용접 기능사 자격증을 땠어요!",eng:"Yes! I got a welding skills certificate!",side:"R"},
    {sp:"안젤라",text:"와, 축하해요! 공부 많이 했어요?",eng:"Wow, congratulations! Did you study hard?",side:"L"},
    {sp:"준",text:"네, 3개월 동안 매일 공부했어요. 정말 힘들었어요.",eng:"Yes, I studied every day for 3 months. It was really hard.",side:"R"},
    {sp:"안젤라",text:"그만한 가치가 있어요. 앞으로 더 좋은 직급이 되겠네요.",eng:"It was worth it. You'll get a better position soon.",side:"L"},
    {sp:"준",text:"감사합니다! 이제 승진을 기대하고 있어요.",eng:"Thank you! Now I'm hoping for promotion.",side:"R"},
  ]},
];

const QUIZ = [
  {q:"'꿈'의 뜻은?",o:["dream","job","place","thing"],a:0},
  {q:"'미래'의 뜻은?",o:["future","past","present","history"],a:0},
  {q:"'자격증'의 뜻은?",o:["certificate/license","house","car","money"],a:0},
  {q:"'~(으)려고 하다'는 언제 써요?",o:["계획을 말할 때","과거를 말할 때","지금을 말할 때","이유를 말할 때"],a:0},
  {q:"'승진'의 뜻은?",o:["promotion","job","company","skill"],a:0},
  {q:"'노력'의 뜻은?",o:["effort/hard work","rest","play","sleep"],a:0},
  {q:"'~게 되다'는 언제 써요?",o:["예상치 못한 변화를 말할 때","계획을 말할 때","과거를 말할 때","이유를 말할 때"],a:0},
  {q:"'꿈을 이루다'의 뜻은?",o:["achieve a dream","have a dream","forget a dream","see a dream"],a:0},
  {q:"'계획'의 뜻은?",o:["plan","dream","money","thing"],a:0},
  {q:"'가족'의 뜻은?",o:["family","friend","company","school"],a:0},
  {q:"'~(으)ㄹ 것이다'는 언제 써요?",o:["미래를 예측할 때","과거를 말할 때","현재를 말할 때","이유를 말할 때"],a:0},
  {q:"'저축'의 뜻은?",o:["savings","spending","money","house"],a:0},
  // 한국의 미래 퀴즈
  {q:"K-조선이 뭐예요?",o:["한국의 조선 산업","중국의 배","미국의 배","일본의 기술"],a:0},
  {q:"한화오션의 미래 비전은?",o:["스마트 조선소, AI·로봇, 친환경","크기만 크게","싸게만 팔기","수입에만 의존"],a:0},
  {q:"'수소경제'란?",o:["수소를 에너지로 사용하는 경제","석유만 사용","전기는 안 쓰기","한국만의 기술"],a:0},
  {q:"한국의 '4차산업혁명'의 핵심은?",o:["AI, 빅데이터, IoT, 로봇","농업","어업","광업"],a:0},
  {q:"'우주항공산업'은 무엇을 하는 산업이에요?",o:["우주선과 비행기 만들기","배 만들기","자동차 만들기","집 짓기"],a:0},
  {q:"한국이 미래에 추구하는 방향은?",o:["친환경, 탄소중립, 지속가능성","산업만 보기","환경은 무시","성장만 추구"],a:0},
];

const CULTURE = [
  {icon:"🚀",t:"한국의 미래 비전",eng:"Korea's Future Vision",d:"한국은 4차 산업혁명의 선도국이 되려고 해요. AI, 로봇, 빅데이터, IoT 등을 활용해서 미래 산업을 만들고 있어요. 스마트 도시, 스마트 조선소 같은 프로젝트를 진행 중이에요.",de:"Korea aims to be a leader in the 4th Industrial Revolution. Using AI, robots, big data, and IoT, Korea is building future industries. Projects like smart cities and smart shipyards are underway."},
  {icon:"🚢",t:"K-조선의 미래",eng:"Korean Shipbuilding Future",d:"한화오션은 세계 최고의 조선소예요. LNG 선박, 해양플랜트 등을 만들고 있어요. 앞으로 자율운항선박과 친환경 선박을 만들 거예요. 한국의 조선 기술이 세계 최고 수준이에요.",de:"Hanwha Ocean is world-leading shipyard. Makes LNG vessels and offshore plants. Will produce autonomous and eco-friendly ships. Korean shipbuilding is world-class."},
  {icon:"🤖",t:"AI & 로봇 산업",eng:"AI & Robotics Industry",d:"한국은 AI와 로봇 개발에서 선도국이에요. 삼성, LG, 현대 등 대기업들이 AI를 활용해요. 의료, 제조, 서비스 산업에서 로봇이 활동하고 있어요. 미래의 조선소도 로봇이 많이 일할 거예요.",de:"Korea leads in AI and robotics. Large companies like Samsung, LG, Hyundai use AI. Robots work in medical, manufacturing, and service sectors. Robots will do much work at future shipyards."},
  {icon:"🛰️",t:"우주항공 산업",eng:"Aerospace Industry",d:"한국은 우주항공 산업을 발전시키고 있어요. 누리호 같은 국산 로켓을 만들었어요. 달 탐사 프로젝트도 진행 중이에요. 우주 산업은 한국의 미래 먹거리예요.",de:"Korea is developing aerospace industry. Created homegrown rockets like Nuri. Moon exploration projects are underway. Space industry is a future growth engine for Korea."},
  {icon:"⚡",t:"수소경제",eng:"Hydrogen Economy",d:"한국은 수소 에너지로 경제를 전환하려고 해요. 수소 버스, 수소 자동차가 도로에 다니고 있어요. 수소 충전소도 계속 늘어나고 있어요. 조선소도 수소로 배를 만드는 기술을 개발 중이에요.",de:"Korea is transitioning to hydrogen-based economy. Hydrogen buses and cars run on roads. Hydrogen charging stations are increasing. Shipyards also developing hydrogen ship technology."},
  {icon:"🌱",t:"친환경 & 탄소중립",eng:"Eco-friendly & Carbon Neutrality",d:"한국은 2050년까지 탄소중립을 이루려고 해요. 풍력, 태양력 같은 재생 에너지를 확대하고 있어요. 조선소도 친환경 선박을 만들고 있어요. 환경과 산업의 균형을 맞추려고 노력해요.",de:"Korea aims for carbon neutrality by 2050. Expanding renewable energy like wind and solar. Shipyards produce eco-friendly ships. Balancing environment and industry."},
];

const LOCAL_INFO = {
  title: "한국의 성장 원동력: 미래 & 혁신",
  eng: "Korea's Growth Engine: Future & Innovation",
  facts: [
    {label:"K-조선 · Korean Shipbuilding",val:"세계 최고의 기술, LNG·해양플랜트, 미래 자율운항"},
    {label:"AI & 로봇 · AI & Robots",val:"삼성·LG·현대, 의료·제조·서비스 로봇"},
    {label:"우주항공 · Aerospace",val:"누리호 국산 로켓, 달 탐사, 우주 산업"},
    {label:"수소경제 · Hydrogen",val:"수소차·버스, 충전소 확대, 수소선박"},
    {label:"자율운항선박 · Autonomous Ships",val:"IoT·AI 기술, 안전성·효율성 향상"},
    {label:"한화오션 비전",val:"스마트 조선소, 친환경, 글로벌 리더"},
    {label:"미래 일자리",val:"기술자, 엔지니어, AI 전문가 필요"},
  ],
  desc: "한국은 미래 산업의 선도국이 돼요! K-조선은 세계 최고의 조선 기술을 가지고 있어요. 한화오션도 스마트 조선소, AI, 로봇으로 미래를 준비하고 있어요. AI와 로봇 산업도 급성장 중이에요. 한국은 4차 산업혁명을 주도하고 있어요. 우주항공, 수소경제 등 새로운 산업도 개발 중이에요. 친환경과 탄소중립도 추구하고 있어요. 이런 미래 산업에서 좋은 기술자와 엔지니어가 필요해요!",
  descEng: "Korea is becoming a leader in future industries! Korean shipbuilding has world-class technology. Hanwha Ocean prepares the future with smart shipyards, AI, and robots. AI and robotics industries are booming. Korea leads the 4th Industrial Revolution. New industries like aerospace and hydrogen economy are developing. Korea also pursues eco-friendliness and carbon neutrality. These future industries need skilled technicians and engineers!"
};

// HANGUL DATA (Level 0 — 20과: 한글 마스터 졸업 시험)
const HANGUL_CONSONANTS = [
  {char:"한화오션에서 일한 지 1년이 됐어요.",rom:"han-hwa o-sean-e-seo il-han ji 1-nyeon-i dwae-sseo-yo.",name:"It's been 1 year working at Hanwha Ocean."},
  {char:"한국어 실력이 많이 늘었어요.",rom:"han-guk-eo sil-ryeok-i man-i neul-eo-sseo-yo.",name:"My Korean has improved a lot."},
  {char:"꿈이 뭐예요?",rom:"kku-mi mwo-ye-yo?",name:"What's your dream?"},
  {char:"저는 한국에서 더 일하고 싶어요.",rom:"jeo-neun han-guk-e-seo deo il-ha-go sip-eo-yo.",name:"I want to work more in Korea."},
  {char:"자격증을 따려고 해요.",rom:"ja-gyeok-jeung-eul tta-ryeo-go hae-yo.",name:"I'm planning to get a certificate."},
  {char:"승진하게 됐어요!",rom:"seung-jin-ha-ge dwae-sseo-yo!",name:"I got promoted!"},
  {char:"2년 후에 사업을 시작할 거예요.",rom:"2-nyeon hu-e sa-eop-eul si-jak-hal geo-ye-yo.",name:"I'll start a business in 2 years."},
  {char:"가족이 저를 응원해요.",rom:"ga-jok-i jeo-reul eung-won-hae-yo.",name:"My family supports me."},
  {char:"저축해서 집을 사고 싶어요.",rom:"jeo-chuk-hae-seo jib-eul sa-go sip-eo-yo.",name:"I want to save and buy a house."},
  {char:"노력하면 성공할 거예요!",rom:"no-ryeok-ha-myeon seong-gong-hal geo-ye-yo!",name:"If I work hard, I will succeed!"},
  {char:"축하합니다!",rom:"chuk-ha-ham-ni-da!",name:"Congratulations!"},
  {char:"감사합니다!",rom:"gam-sa-ham-ni-da!",name:"Thank you!"},
];
const HANGUL_VOWELS = [
  {char:"자기소개서 쓰기",rom:"ja-gi-so-gae-seo sseu-gi",name:"Writing self-introduction letter"},
  {char:"저는 라민이에요.",rom:"jeo-neun ra-min-i-e-yo.",name:"My name is Ramin."},
  {char:"베트남에서 왔어요.",rom:"be-tu-nam-e-seo wa-sseo-yo.",name:"I came from Vietnam."},
  {char:"조선소에서 용접공으로 일하고 있어요.",rom:"jo-seon-so-e-seo yong-jeop-gong-eu-ro il-ha-go i-sseo-yo.",name:"I work as a welder at the shipyard."},
  {char:"미래 계획 쓰기",rom:"mi-rae gye-hoek sseu-gi",name:"Writing future plans"},
  {char:"2년 더 일한 후에 자격증을 따고 싶어요.",rom:"2-nyeon deo il-han hu-e ja-gyeok-jeung-eul tta-go sip-eo-yo.",name:"I want to get a certificate after 2 more years."},
  {char:"그 다음에는 한국에서 작은 사업을 시작할 거예요.",rom:"geu da-eum-e-neun han-guk-e-seo ja-geun sa-eop-eul si-jak-hal geo-ye-yo.",name:"Then I will start a small business in Korea."},
  {char:"꿈을 이루려고 열심히 노력하고 있어요.",rom:"kku-meul i-ru-ryeo-go yeol-sim-hi no-ryeok-ha-go i-sseo-yo.",name:"I'm working hard to achieve my dreams."},
  {char:"한국 생활이 정말 좋아요.",rom:"han-guk saeng-hwal-i jeong-mal jo-a-yo.",name:"Korean life is really good."},
  {char:"가족과 친구들이 저를 응원해요.",rom:"ga-jok-gwa chin-gu-deul-i jeo-reul eung-won-hae-yo.",name:"My family and friends support me."},
  {char:"감사하는 마음으로 더 열심히 하겠어요!",rom:"gam-sa-ha-neun ma-eum-eu-ro deo yeol-sim-hi ha-ge-sseo-yo!",name:"With gratitude, I will work even harder!"},
  {char:"20과 완성!",rom:"20-gwa wan-seong!",name:"Lesson 20 Complete!"},
];
const HANGUL_PRACTICE = [
  {char:"① 기초 복습 (Basics Review)",rom:"",name:""},
  {char:"ㄱ ㄴ ㄷ ㄹ ㅁ ㅂ ㅅ ㅇ",rom:"consonants",name:"자음 review"},
  {char:"ㅏ ㅑ ㅓ ㅕ ㅗ ㅜ ㅡ ㅣ",rom:"vowels",name:"모음 review"},
  {char:"② 단어 읽기 (Word Reading)",rom:"",name:""},
  {char:"꿈, 미래, 계획, 목표, 노력, 성공",rom:"kkum, mi-rae, gye-hoek, mok-pyo, no-ryeok, seong-gong",name:"Future vocabulary"},
  {char:"③ 문장 읽기 (Sentence Reading)",rom:"",name:""},
  {char:"꿈이 뭐예요? / 미래 계획이 뭐예요?",rom:"dreams/plans questions",name:"Questions"},
  {char:"저는 한국에서 더 일하고 싶어요.",rom:"I want to work more in Korea",name:"Statement"},
  {char:"④ 쓰기 연습 (Writing Practice)",rom:"",name:""},
  {char:"이름, 나라, 일, 꿈, 계획 쓰기",rom:"name, country, job, dream, plans",name:"Writing practice"},
  {char:"⑤ 발음 확인 (Pronunciation Check)",rom:"",name:""},
  {char:"모든 학습 내용 발음 확인",rom:"all lesson pronunciation",name:"Final check"},
];
const SAFETY_WORDS = [
  {kor:"축하합니다!",eng:"Congratulations!",rom:"chuk-ha-ham-ni-da!"},
  {kor:"20과를 마쳤어요!",eng:"I completed Lesson 20!",rom:"20-gwa-reul ma-chyeo-sseo-yo!"},
  {kor:"한글 마스터가 되셨어요!",eng:"You became a Hangul master!",rom:"han-geul mas-teo-ga dwae-syeo-sseo-yo!"},
  {kor:"정말 잘했어요!",eng:"You did really well!",rom:"jeong-mal jal-hae-sseo-yo!"},
  {kor:"진심으로 감사합니다.",eng:"Thank you sincerely.",rom:"jin-sim-eu-ro gam-sa-ham-ni-da."},
  {kor:"수고 많으셨어요!",eng:"You worked hard!",rom:"su-go man-eu-syeo-sseo-yo!"},
  {kor:"앞으로 더 잘하실 거예요!",eng:"You will do even better!",rom:"a-peu-ro deo jal-ha-sil geo-ye-yo!"},
  {kor:"파이팅!",eng:"Fighting!/Do your best!",rom:"pa-i-ting!"},
  {kor:"성공을 응원해요!",eng:"I support your success!",rom:"seong-gong-eul eung-won-hae-yo!"},
  {kor:"꿈을 이루세요!",eng:"Achieve your dreams!",rom:"kku-meul i-ru-se-yo!"},
  {kor:"한국을 사랑해 주셔서 감사해요!",eng:"Thank you for loving Korea!",rom:"han-guk-eul sa-rang-hae ju-syeo-seo gam-sa-hae-yo!"},
  {kor:"또 만나요!",eng:"See you again!",rom:"tto man-na-yo!"},
];
const HANGUL_TABS = ['읽기 시험 Reading','쓰기 시험 Writing','종합 시험 Test','졸업 축하 🎉'];
const HANGUL_SUBTITLE = "한글 마스터 · 졸업 시험 & 축하";

// ===== READING PASSAGES =====
const READING_PASSAGES = [
  {title:"꿈과 미래",eng:"Dreams and Future",
   text:"라민 씨의 꿈이 뭐예요?\n라민 씨는 한국에서 사업을 하고 싶어요.\n먼저 한화오션에서 2년 더 일할 거예요.\n그 동안 돈을 저축하고 기술을 배울 거예요.\n자격증도 따려고 해요.\n2년 후에 한국에서 작은 사업을 시작할 거예요.\n가족은 라민 씨를 응원해요.\n'꿈을 이루려면 노력해야 해!'라고 말해요.\n라민 씨는 열심히 일하고 있어요.\n한국 생활도 좋아하고, 미래도 밝아요.",
   textEng:"What's Ramin's dream?\nRamin wants to do business in Korea.\nFirst, he will work at Hanwha Ocean for 2 more years.\nDuring that time, he will save money and learn skills.\nHe's also planning to get a certificate.\nIn 2 years, he will start a small business in Korea.\nHis family supports Ramin.\nThey say, 'You must work hard to achieve your dreams!'\nRamin is working hard.\nHe likes Korean life and has a bright future.",
   questions:[
     {q:"라민 씨의 꿈은 뭐예요?",a:"한국에서 사업을 하는 것",ae:"To run a business in Korea"},
     {q:"라민 씨는 언제까지 한화오션에서 일할 거예요?",a:"2년 더",ae:"2 more years"},
     {q:"라민 씨가 하려는 것들은?",a:"저축, 기술 배우기, 자격증 따기",ae:"Save, learn skills, get certificate"},
   ]},
  {title:"한국의 미래",eng:"Korea's Future",
   text:"한국은 미래 산업의 선도국이 될 거예요.\n조선 산업이 세계 최고 수준이에요.\n한화오션은 스마트 조선소로 변하고 있어요.\nAI와 로봇이 조선소에서 많이 일할 거예요.\n한국은 우주항공, 수소경제 같은 새로운 산업도 개발하고 있어요.\n이런 미래 산업에서 좋은 기술자가 필요해요.\n외국인 근로자도 한국의 미래에 함께할 수 있어요.\n더 배우고, 더 노력하면 성공할 수 있어요!\n한국에서 꿈을 이루세요!",
   textEng:"Korea will become a leader in future industries.\nThe shipbuilding industry is world-class.\nHanwha Ocean is transforming into a smart shipyard.\nAI and robots will do much work at shipyards.\nKorea is also developing new industries like aerospace and hydrogen economy.\nThese future industries need skilled technicians.\nForeign workers can also be part of Korea's future.\nYou can succeed by learning more and working harder!\nAchieve your dreams in Korea!",
   questions:[
     {q:"한국은 무엇의 선도국이 될 거예요?",a:"미래 산업",ae:"Future industries"},
     {q:"한화오션은 어떻게 변하고 있어요?",a:"스마트 조선소로",ae:"Into a smart shipyard"},
     {q:"한국이 개발하는 새로운 산업은?",a:"우주항공, 수소경제 등",ae:"Aerospace, hydrogen economy, etc."},
   ]},
];
...
const FOLKTALE = {
  title: "별주부전 / 토끼와 자라",
  eng: "The Rabbit and the Turtle — Wit Over Power",
  desc: "재치 있는 토끼의 이야기입니다.",
  descEng: "The story of a witty rabbit — intelligence beats strength.",
  sentences: [
    {kor:"옛날에 토끼와 자라가 살았어요.",eng:"Once upon a time, a rabbit and a turtle lived."},
    {kor:"토끼는 영리하고 빠르기로 유명했어요.",eng:"The rabbit was famous for being clever and fast."},
    {kor:"자라는 느리지만 착한 동물이었어요.",eng:"The turtle was slow but kind."},
    {kor:"한 번은 자라가 용궁에 초대를 받았어요.",eng:"One day, the turtle was invited to the dragon's palace."},
    {kor:"용궁은 용 왕이 사는 바다 아래의 궁전이에요.",eng:"The dragon's palace is an underwater kingdom where the dragon king lives."},
    {kor:"자라는 토끼를 초대하고 싶었어요.",eng:"The turtle wanted to invite the rabbit."},
    {kor:"'내 친구를 데려가도 될까요?'라고 물었어요.",eng:"He asked, 'Can I bring my friend?'"},
    {kor:"용 왕은 '좋아! 토끼를 데려 와.'라고 말했어요.",eng:"The dragon king said, 'Sure! Bring the rabbit!'"},
    {kor:"자라가 토끼를 찾아갔어요.",eng:"The turtle went to find the rabbit."},
    {kor:"'용궁에 가자. 정말 재미있어!'라고 권했어요.",eng:"He invited, 'Let's go to the dragon's palace. It's really fun!'"},
    {kor:"토끼는 의심했어요.",eng:"The rabbit was suspicious."},
    {kor:"'바다 아래는 숨을 쉴 수 없어. 어떻게 가?'",eng:"'How can we go? I can't breathe underwater!'"},
    {kor:"자라가 말했어요.",eng:"The turtle explained."},
    {kor:"'걱정하지 마. 나를 따라오면 돼.'",eng:"'Don't worry. Just follow me.'"},
    {kor:"토끼는 자라 등에 탔어요.",eng:"The rabbit jumped on the turtle's back."},
    {kor:"자라는 물속으로 내려갔어요.",eng:"The turtle went underwater."},
    {kor:"신기한 용궁이 나타났어요!",eng:"A magical underwater palace appeared!"},
    {kor:"용 왕이 환영했어요.",eng:"The dragon king welcomed them."},
    {kor:"'어서 와! 연회를 시작하자!'",eng:"'Welcome! Let's start the feast!'"},
    {kor:"하지만 연회가 시작되자 이상한 일이 생겼어요.",eng:"But something strange happened when the feast started."},
    {kor:"용 왕이 말했어요.",eng:"The dragon king said."},
    {kor:"'실은 나는 간이 아파. 토끼의 간을 먹으면 낫는대.'",eng:"'I'm sick with liver disease. Eating a rabbit's liver will cure me.'"},
    {kor:"토끼는 깜짝 놀랐어요!",eng:"The rabbit was startled!"},
    {kor:"하지만 토끼는 화내지 않았어요.",eng:"But the rabbit didn't get angry."},
    {kor:"똑똑한 토끼는 재빨리 생각했어요.",eng:"The clever rabbit thought quickly."},
    {kor:"'아, 간 말이에요?'라고 말했어요.",eng:"'Oh, you mean my liver?'"},
    {kor:"'제 간은 집에 두고 왔어요.'",eng:"'I left it at home.'"},
    {kor:"자라가 놀랐어요.",eng:"The turtle was shocked."},
    {kor:"토끼가 계속 말했어요.",eng:"The rabbit continued."},
    {kor:"'급할 때는 간을 빼낼 수는 없어요.'",eng:"'You can't remove a liver in a hurry.'"},
    {kor:"'다시 가서 가져올게요! 나 좀 내려놔.'",eng:"'Let me go get it! Put me down.'"},
    {kor:"용 왕은 토끼의 말을 믿었어요.",eng:"The dragon king believed the rabbit."},
    {kor:"자라가 토끼를 데려다 놨어요.",eng:"The turtle set the rabbit down."},
    {kor:"하지만 토끼는 도망쳤어요!",eng:"But the rabbit ran away!"},
    {kor:"빠른 토끼는 자라를 따돌렸어요.",eng:"The fast rabbit outran the turtle."},
    {kor:"토끼는 집으로 돌아갔어요.",eng:"The rabbit returned home."},
    {kor:"자라는 뒤에서 따라왔지만 따라잡지 못했어요.",eng:"The turtle followed but couldn't catch up."},
    {kor:"이 이야기는 힘보다는 지혜가 중요하다는 뜻이에요.",eng:"This story means wisdom is more important than strength."},
    {kor:"빠르고 힘센 것도 중요하지만, 똑똑한 것이 더 중요해요.",eng:"Being fast and strong is important, but being smart is more important."},
    {kor:"조선소에서도 열심히만 할 게 아니라 똑똑하게 일해야 해요.",eng:"At the shipyard, it's not enough to just work hard — you must work smart."},
    {kor:"함께 생각하고 협력하면 더 큰 일을 이룰 수 있어요!",eng:"By thinking together and cooperating, we can achieve greater things!"},
  ]
};

const FOLKTALE_QUIZ = [
  {q:"토끼는 어떤 동물이었어요?",o:["영리하고 빠른 동물","느린 동물","강한 동물","무서운 동물"],a:0},
  {q:"자라는 어디에 초대를 받았어요?",o:["용궁","숲","산","마을"],a:0},
  {q:"용 왕이 원한 것은?",o:["토끼의 간","토끼의 귀","토끼의 꼬리","토끼의 발"],a:0},
  {q:"토끼는 어떻게 도망쳤어요?",o:["간은 집에 뒀다고 말하고","헤엄쳐서","뛰어서","날아서"],a:0},
  {q:"자라는 토끼를 따라잡았어요?",o:["아니오, 못 따라잡았어요","네, 따라잡았어요","모르겠어요","반은 따라잡았어요"],a:0},
  {q:"이 이야기의 교훈은?",o:["지혜가 힘보다 중요하다","힘이 제일 중요하다","빠르기만 하면 된다","혼자가 좋다"],a:0},
  {q:"토끼가 생각한 좋은 핑계는?",o:["간은 집에 두고 왔다","배가 아프다","다리가 아프다","못 들었다"],a:0},
  {q:"용궁은 어디 있어요?",o:["바다 아래","숲속","산 위","마을"],a:0},
  {q:"이 이야기를 조선소에 적용하면?",o:["열심히 할 뿐만 아니라 똑똑하게 일해야 한다","혼자 일해야 한다","쉽게 일해야 한다","협력하면 안 된다"],a:0},
  {q:"토끼와 자라 중에 누가 더 똑똑했어요?",o:["토끼","자라","둘 다","모르겠어요"],a:0},
  {q:"용 왕은 토끼의 말을 어떻게 생각했어요?",o:["믿었어요","의심했어요","웃었어요","화냈어요"],a:0},
  {q:"이 이야기는 어느 나라 이야기예요?",o:["한국 전래동화","중국","일본","서양"],a:0},
  {q:"토끼가 집으로 돌아갈 때 자라는?",o:["뒤에서 따라왔지만 못 따라잡았어요","앞에서 기다렸어요","포기했어요","다른 곳에 갔어요"],a:0},
  {q:"자라가 토끼를 데려간 이유는?",o:["친구니까","자기 몸을 팔려고","용 왕이 시켰으니까","혼자라서"],a:0},
  {q:"'별주부전'은 누구의 관점 이야기예요?",o:["자라 관점","토끼 관점","용 왕 관점","무인도의 관점"],a:0},
];

const REVIEW_DATA = {
  preview: {
    title: "🎓 축하합니다!",
    desc: "20과 전체 과정을 모두 마쳤습니다!",
    descEng: "Congratulations! You completed all 20 lessons!",
    items: [
      {label:"시작",val:"안녕하세요 · Hello (Lesson 1)",detail:"인사와 기본 인사"},
      {label:"중간",val:"여행, 취미, 문화 (Lessons 8-17)",detail:"한국 생활과 문화 이해"},
      {label:"완성",val:"꿈과 미래 · Dreams & Future (Lesson 20)",detail:"미래 계획과 한국의 비전"},
      {label:"성과",val:"한글 마스터 & 기본 의사소통 완성!",detail:"Hangul master & Basic communication!"},
    ]
  },
  review: {
    title: "복습 · Review: 20과 총정리",
    desc: "20과에서 배운 꿈과 미래 내용을 정리했습니다.",
    descEng: "Review of dreams, future, and Korean innovation from Lesson 20.",
    sections: [
      {title:"꿈 & 미래 어휘",icon:"🎯",items:["꿈/미래/계획/목표","희망/성공/노력/도전","경험/실력/자격증/승진"]},
      {title:"미래 문법 (Grammar)",icon:"📝",items:["~(으)려고 하다 (planning to)","~게 되다 (come to/turn out)","~(으)ㄹ 것이다 (will/going to)","미래 표현 완성"]},
      {title:"한국의 미래",icon:"🚀",items:["K-조선/스마트조선소","AI·로봇·우주항공","수소경제·탄소중립","한화오션 비전"]},
      {title:"한글 마스터 축하!",icon:"🎉",items:["자음·모음 완벽 마스터","문장 읽고 쓰기 완성","0급 졸업 시험 통과","한국 생활 준비 완료!"]},
    ]
  },
  dictation: [
    "꿈이 뭐예요? 저는 한국에서 사업을 하고 싶어요.",
    "2년 더 일한 후에 자격증을 따려고 해요.",
    "승진하게 됐어요! 정말 기뻐요.",
    "노력하면 성공할 거예요.",
    "한국 생활이 정말 좋아요.",
    "가족이 저를 응원해요.",
...
function renderNav() {
  const items = [
    ...
    {id:'culture',l:'문화',i:'🏛️'},{id:'geoje',l:'미래 & 혁신',i:'🚀'},{id:'ai',l:'AI실습',i:'🤖'},
  ];
  let menu = '';
  if (state.menuOpen) {
...
function renderHome() {
  ...
  <div style="background:linear-gradient(135deg,#1E3A5F,#2E75B6);border-radius:16px;padding:20px;margin-bottom:16px;color:#fff">
    <div style="font-size:12px;color:#8899BB;margin-bottom:2px">초급 20과 · Beginner Lesson 20</div>
    <div style="display:flex;gap:6px;justify-content:center;margin-top:8px;flex-wrap:wrap">
      ...
      <span style="background:linear-gradient(135deg,#3b82f6,#1d4ed8);color:#fff;padding:4px 12px;border-radius:20px;font-size:11px;font-weight:700">🎓 1급 초급 1 완료!</span>
    </div
    <div style="font-size:26px;font-weight:800;margin-bottom:2px">꿈이 뭐예요?</div>
    <div style="font-size:13px;color:#aabbdd">What's your dream? — 꿈과 미래 · Dreams & Future Plans</div>
    <div style="margin-top:12px;display:flex;gap:6px;flex-wrap:wrap">
      ${['~(으)려고 하다','~게 되다','~(으)ㄹ 것이다','미래 표현'].map(o=>`<span style="background:rgba(255,255,255,0.12);border-radius:6px;padding:3px 10px;font-size:11px">✓ ${o}</span>`).join('')}
    </div>
  </div>
  ...
  <button onclick="setState({page:'geoje'})" class="btn btn-navy" style="margin-bottom:8px">🚀 한국의 미래 보기</button>
  <button onclick="setState({page:'curriculum'})" class="btn" style="background:#e5e7eb;color:#555">📋 전체 커리큘럼 보기</button>
  <div style="display:flex;gap:8px;margin-top:12px"><a href="/HanwhaOcean_Level1_Lesson19" style="flex:1;padding:12px;border-radius:10px;background:#e5e7eb;color:#555;font-size:13px;font-weight:700;text-align:center;text-decoration:none">← 19과 한국 생활이 어때요?</a><a href="/HanwhaOcean_Level1_Lesson1" style="flex:1;padding:12px;border-radius:10px;background:#10b981;color:#fff;font-size:13px;font-weight:700;text-align:center;text-decoration:none">🎓 수료! 처음부터 다시</a></div>`;
}
...
function renderCurriculum() {
  ...
  ${levels.map(lv=>`<div class="card" style="border-left:4px solid ${lv.c}">
    ...
    <div class="progress"><div class="progress-bar" style="width:${lv.id<=1?(lv.id===1?'100%':'0%'):'0%'};background:${lv.c}"></div></div>
  </div>`).join('')}`;
}
...
function renderHangul() {
  ...
  const progressLabel = "20/20";

  return `<h2>🔤 0급 한글 응용 · ${HANGUL_SUBTITLE}</h2><p class="sub">${HANGUL_SUBTITLE}</p>
  <div style="margin-bottom:12px;background:#e5e7eb;border-radius:8px;overflow:hidden;position:relative;height:22px;border:2px solid #10b981">
    <div style="width:${progressPct}%;height:100%;background:linear-gradient(90deg,#10b981,#059669);border-radius:6px;transition:width 0.5s"></div>
    <div style="position:absolute;top:0;left:0;right:0;text-align:center;font-size:11px;font-weight:700;line-height:22px;color:#fff">🎓 한글 마스터 졸업! ${progressLabel} (${progressPct}%)</div>
  </div>
...
function renderVocab() {
  const tabs = ['꿈 Dreams','조선소 Shipyard','미래 Future','도구·장비 Tools&Equip'];
  const t = state.vocabTab;
  let content = '';
  if (t===0) content = VOCAB_DREAM.map((v,i)=>`
  ...
  else if (t===2) content = `<div class="grid2">${VOCAB_FUTURE.map(v=>`
  ...
  return `<h2>📖 어휘 · Vocabulary</h2><p class="sub">20과 핵심 어휘 (${VOCAB_DREAM.length+VOCAB_SHIPYARD.length+VOCAB_FUTURE.length+VOCAB_SHIPYARD_NOUNS.length}단어)</p>
...
function renderGrammar() {
  ...
  return `<h2>✏️ 문법 · Grammar</h2><p class="sub">20과 핵심 문법 ${GRAMMAR.length}개</p>
...
function renderWriting() {
  const preview = state.wrName ? `축하합니다! ${state.wrName} 님은 20과를 완성했어요!
${state.wrCountry?'꿈: '+state.wrCountry:''}
${state.wrJob?'계획: '+state.wrJob:''}
${state.wrExtra?state.wrExtra:''}
한국의 미래에서 성공하세요!` : '';

  return `<h2><span class="section-icon">✍️</span>쓰기 · Writing</h2><p class="sub">나의 꿈과 미래 계획 · My Dreams & Future Plans</p>
  <div class="card" style="background:#fff7ed;border:2px solid var(--orange)">
    <b style="color:var(--orange)">📋 나의 꿈과 미래 계획을 써 보세요 · Write your dreams and future plans</b>
  </div>
  <div style="margin-top:12px">
    ...
    <label style="font-size:13px;font-weight:700;color:var(--navy)">꿈이 뭐예요? What's your dream?</label>
    <input class="input" placeholder="예: 한국에서 사업을 하고 싶어요 / Start a business in Korea" value="${state.wrCountry}" oninput="state.wrCountry=this.value;render()">
    <label style="font-size:13px;font-weight:700;color:var(--navy)">계획은? What's your plan?</label>
    <input class="input" placeholder="예: 2년 더 일하고 자격증을 따요 / 2 more years + get certificate" value="${state.wrJob}" oninput="state.wrJob=this.value;render()">
    <label style="font-size:13px;font-weight:700;color:var(--navy)">더 쓰고 싶은 말 More to say</label>
    <input class="input" placeholder="예: 노력하면 성공할 거예요! / I will succeed if I work hard!" value="${state.wrExtra}" oninput="state.wrExtra=this.value;render()">
  </div>
  ${preview?`
  ...
  <button class="btn btn-primary" style="margin-top:10px" onclick="TTS.speak(\`${preview.replace(/\n/g,' ').replace(/님은/g,'님은')}\`,undefined,0.8)">🔊 발표 연습 듣기 · Listen to Presentation</button>
  `:'<div style="color:#ccc;text-align:center;margin:30px 0">위에 정보를 입력하면 나의 꿈과 미래 계획이 만들어집니다.<br>Fill in the fields above to generate your dreams and future plans.</div>'}

  <div style="margin-top:20px;font-weight:700;color:var(--navy);margin-bottom:8px">✍️ 자유 쓰기 · Free Writing</div>
  <textarea placeholder="자유롭게 한국어로 써 보세요.&#10;Write freely in Korean.&#10;&#10;예: 저의 꿈은 한국에서 사업을 하는 것이에요.&#10;2년 더 일한 후에 자격증을 따려고 해요.&#10;노력하면 성공할 거예요!"></textarea>`;
}

function renderFlashcard() {
  const all = [...VOCAB_DREAM.map(v=>({f:v.kor,b:v.eng})),...VOCAB_FUTURE.map(v=>({f:v.kor,b:v.eng})),...VOCAB_SHIPYARD_NOUNS.map(v=>({f:v.kor,b:v.eng}))];
...
function renderCulture() {
  return `<h2>🏛️ 문화와 정보 · Culture & Info</h2><p class="sub">한국의 미래 · Korea's Future & Innovation</p>
  ...
  <button onclick="setState({page:'geoje'})" class="btn btn-navy" style="margin-top:10px">🚀 한국의 미래 보기</button>`;
}
...
function renderReview() {
  ...
  if (t===0) { // 복습
    ...
    <button onclick="TTS.speak('${rv.sections[0].items.join('. ')}')" class="btn btn-primary" style="margin-top:8px">🔊 핵심 미래 표현 전체 듣기</button>`;
  }
  if (t===1) { // 예습
    ...
    <div class="card" style="background:linear-gradient(135deg,#f0f7ff,#fff7ed);border:2px solid var(--ocean)">
      ...
      <div style="font-size:12px;color:#888;margin-bottom:12px">20과를 미리 살펴보세요!</div>
    </div>
    ${pv.items.map((item,i)=>`
    ...
    <div class="card card-green" style="background:var(--light-green)">
      ...
      <div style="font-size:13px;color:#333;line-height:1.6">
        1. 꿈과 미래 관련 어휘를 3번씩 읽어 보세요.<br>
        2. 여러분의 꿈과 미래 계획을 한국어로 말해 보세요.<br>
        3. 한국의 미래와 한화오션의 비전을 알아보세요.
      </div>
      <div style="font-size:12px;color:#888;margin-top:6px;line-height:1.5">
        1. Read dream and future vocabulary 3 times.<br>
        2. Describe your dreams and future plans in Korean.<br>
        3. Learn about Korea's future and Hanwha Ocean's vision.
      </div>
    </div>`;
  }
  // t===2: 받아쓰기
...
function renderGeoje() {
  ...
  <div class="card" style="background:var(--light-orange);border:2px solid var(--orange)">
    <b style="color:var(--orange)">🚀 한국의 성장 원동력: 미래 & 혁신 Future & Innovation</b>
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ${[
        {item:'K-조선',price:'세계 최고 기술',emoji:'🚢',eng:'Korean Shipbuilding'},
        {item:'스마트조선소',price:'AI·로봇',emoji:'🤖',eng:'Smart Shipyard'},
        {item:'우주항공',price:'우주 산업',emoji:'🛰️',eng:'Aerospace'},
        {item:'수소경제',price:'친환경 에너지',emoji:'⚡',eng:'Hydrogen Economy'},
        {item:'자율운항',price:'미래 선박',emoji:'🌊',eng:'Autonomous Ships'},
        {item:'한화오션 비전',price:'글로벌 리더',emoji:'🏆',eng:'HO Vision'},
      ].map(p=>`
...
var AI_QUICK_BTNS = [
  {emoji:'🔮',label:'(으)ㄹ 거예요',
   q:'으ㄹ거예요만들기 future tense 미래형 ㄹ거예요를 알려주세요' },
  {emoji:'📅',label:'계획 말하기',
   q:'계획말하기 describing plans 앞으로계획 무슨계획을 알려주세요' },
  {emoji:'⭐',label:'희망/꿈 표현',
   q:'희망꿈표현 hope dream 고싶어요 원해요를 알려주세요' },
  {emoji:'🎯',label:'미래 목표',
   q:'미래목표 future goal 목표말하기 앞으로를 알려주세요' },
  {emoji:'🗣️',label:'미래 대화',
   q:'미래대화 future conversation 계획이야기 꿈이야기를 알려주세요' }
];
var AICHAT = {
  msgs: [],
  loading: false,
  ...
  send: async function(text, label) {
    ...
    try {
      var sysP = 'You are a Korean future goals and aspirations coach for shipyard workers. Lesson focus: goal vocab 꿈(dream), 미래(future), 계획(plan), 목표(goal), 자격증(certificate), intention expression ~(으)려고 하다 (intend to/plan to). Help workers express career and life goals. SHORT answers with English. LESSON:L1L20';
      var url = '/api/chat';
...
function renderAI() {
  ...
  <div style="background:linear-gradient(135deg,#1E3A5F,#2E75B6);color:#fff;border-radius:12px;padding:16px;margin-bottom:12px">
    ...
    <div style="font-size:15px;font-weight:800;margin-bottom:6px">🚀 AI 미래 계획 코치</div>
    <div style="font-size:11px;opacity:0.85;line-height:1.7">꿈 · 자격증 · 목표 선언 표현<br>
    <span style="color:#93c5fd">🔵 Future Goals Coach × Aspiration Korean</span></div>
  </div>
    ...
    <details style="margin-bottom:8px">
      ...
      <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:0 0 8px 8px;padding:12px;font-size:12px;line-height:1.9;color:#1a202c">
        ...
        <div style="background:#fff;border-radius:6px;padding:8px;margin:4px 0;border-left:3px solid #2563eb">
          ...
          <span style="font-family:monospace;background:#dbeafe;padding:4px 8px;border-radius:4px;display:block;margin:4px 0;font-size:11px;line-height:1.6">"저는 한화오션 조선소 외국인 근로자예요. 한국어로 미래 꿈과 목표를 표현하는 연습을 도와주세요. 자격증 취득 계획과 한국 생활 후 미래를 이야기하는 표현을 영어로도 설명해 주세요."</span>
