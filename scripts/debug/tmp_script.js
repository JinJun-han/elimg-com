...
var AI_QUICK_BTNS = [
  ...
  send: async function(text, label) {
    ...
    try {
      var sysP = 'You are a Korean future goals and aspirations coach for shipyard workers. Lesson focus: goal vocab 꿈(dream), 미래(future), 계획(plan), 목표(goal), 자격증(certificate), intention expression ~(으)려고 하다 (intend to/plan to). Help workers express career and life goals. SHORT answers with English.
LESSON:L1L20';
      var url = '/api/chat';
