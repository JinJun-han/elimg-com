...
// ===== DATA =====
const VOCAB_LIFE = [
  {kor:"생활",pron:"saeng-hwal",eng:"life/living"},
  {kor:"적응",pron:"jeok-eung",eng:"adaptation/adjustment"},
  {kor:"문화 차이",pron:"mun-hwa cha-i",eng:"cultural difference"},
  {kor:"향수병",pron:"hyang-su-byeong",eng:"homesickness"},
  {kor:"날씨",pron:"nal-ssi",eng:"weather"},
  {kor:"음식",pron:"eum-sik",eng:"food"},
  {kor:"교통",pron:"gyo-tong",eng:"transportation"},
  {kor:"친구",pron:"chin-gu",eng:"friend"},
  {kor:"동료",pron:"dong-ryo",eng:"colleague"},
  {kor:"고향",pron:"go-hyang",eng:"hometown"},
  {kor:"명절",pron:"myeong-jeol",eng:"holiday/festival"},
  {kor:"추석",pron:"chu-seok",eng:"Chuseok (harvest festival)"},
  {kor:"설날",pron:"seol-nal",eng:"Lunar New Year"},
  {kor:"다문화",pron:"da-mun-hwa",eng:"multicultural"},
  {kor:"외국인",pron:"oe-guk-in",eng:"foreigner"},
  {kor:"한국인",pron:"han-guk-in",eng:"Korean person"},
  {kor:"이해하다",pron:"i-hae-ha-da",eng:"to understand"},
  {kor:"존중하다",pron:"jon-jung-ha-da",eng:"to respect"},
];

const VOCAB_SHIPYARD = [
  {kor:"한국 생활 어때요?",eng:"How's life in Korea?",sit:"인사"},
  {kor:"처음에는 힘들었어요.",eng:"It was hard at first.",sit:"적응"},
  {kor:"지금은 괜찮아요.",eng:"Now it's okay.",sit:"현재"},
  {kor:"매운 음식을 잘 먹는 것 같아요.",eng:"I seem to eat spicy food well.",sit:"음식"},
  {kor:"한국 문화가 다르더라고요.",eng:"Korean culture is quite different, you know.",sit:"문화"},
  {kor:"고향이 그리워요.",eng:"I miss my hometown.",sit:"향수병"},
  {kor:"한국 친구들이 좋아요.",eng:"I like Korean friends.",sit:"친구"},
  {kor:"동료들이 도와줘요.",eng:"Colleagues help me.",sit:"동료"},
  {kor:"버스 타는 것이 쉬워요.",eng:"It's easy to take the bus.",sit:"교통"},
  {kor:"편의점이 많아요.",eng:"There are many convenience stores.",sit:"편의"},
  {kor:"배달 앱이 좋더라고요.",eng:"Delivery apps are great, you know.",sit:"배달"},
  {kor:"카드로 다 결제해요.",eng:"I pay for everything with a card.",sit:"결제"},
  {kor:"명절 때 향수병이 심해요.",eng:"Homesickness gets worse during holidays.",sit:"명절"},
  {kor:"추석에 고향 생각이 나요.",eng:"I think of home during Chuseok.",sit:"명절"},
  {kor:"한국의 다문화를 존중해요.",eng:"I respect Korea's multiculturalism.",sit:"다문화"},
  {kor:"외국인과 한국인이 함께 살아요.",eng:"Foreigners and Koreans live together.",sit:"공존"},
];

const VOCAB_DAILY = [
  {kor:"편의점",eng:"convenience store"},{kor:"대중교통",eng:"public transportation"},
  {kor:"배달앱",eng:"delivery app"},{kor:"카드결제",eng:"card payment"},
  {kor:"의료보험",eng:"health insurance"},{kor:"주택",eng:"housing"},
  {kor:"전세",eng:"jeonse (lump sum rental)"},{kor:"월세",eng:"monthly rent"},
  {kor:"아파트",eng:"apartment"},{kor:"자취",eng:"living alone"},
  {kor:"기숙사",eng:"dormitory"},{kor:"음식점",eng:"restaurant"},
  {kor:"마트",eng:"supermarket"},{kor:"버스",eng:"bus"},
  {kor:"지하철",eng:"subway"},{kor:"택시",eng:"taxi"},
  {kor:"자동차",eng:"car"},{kor:"신발",eng:"shoes"},
  {kor:"옷",eng:"clothes"},{kor:"가방",eng:"bag"},
  {kor:"책",eng:"book"},{kor:"핸드폰",eng:"mobile phone"},
  {kor:"컴퓨터",eng:"computer"},{kor:"영어",eng:"English"},
  {kor:"중국어",eng:"Chinese"},{kor:"베트남어",eng:"Vietnamese"},
  {kor:"인도네시아어",eng:"Indonesian"},{kor:"일본어",eng:"Japanese"},
  {kor:"태국어",eng:"Thai"},{kor:"필리핀어",eng:"Filipino"},
  {kor:"스페인어",eng:"Spanish"},{kor:"프랑스어",eng:"French"},
  {kor:"포르투갈어",eng:"Portuguese"},{kor:"한국어",eng:"Korean"},
  {kor:"회사",eng:"company"},{kor:"조선소",eng:"shipyard"},
];

const VOCAB_SHIPYARD_NOUNS = [
  {kor:"다문화가족",eng:"multicultural family"},{kor:"외국인근로자",eng:"foreign worker"},
  {kor:"고용허가제",eng:"employment permit system"},{kor:"사회통합프로그램",eng:"social integration program"},
  {kor:"KIIP",eng:"KIIP (Korea Immigration & Integration Program)"},{kor:"다문화센터",eng:"multicultural center"},
  {kor:"한국문화",eng:"Korean culture"},{kor:"전통문화",eng:"traditional culture"},
  {kor:"명절 문화",eng:"holiday culture"},{kor:"음식 문화",eng:"food culture"},
  {kor:"추석",eng:"Chuseok"},{kor:"설날",eng:"Lunar New Year"},
  {kor:"가족",eng:"family"},{kor:"친척",eng:"relatives"},
  {kor:"고향 음식",eng:"hometown food"},{kor:"고향 말",eng:"hometown dialect"},
  {kor:"적응",eng:"adaptation"},{kor:"이해",eng:"understanding"},
  {kor:"존중",eng:"respect"},{kor:"포용",eng:"inclusion"},
  {kor:"글로벌 인재",eng:"global talent"},{kor:"국제화",eng:"internationalization"},
  {kor:"외국인 지원",eng:"foreign worker support"},{kor:"한국어 교육",eng:"Korean language education"},
  {kor:"문화 교육",eng:"cultural education"},{kor:"사회적응 교육",eng:"social adaptation training"},
  {kor:"고용 서비스",eng:"employment service"},{kor:"상담",eng:"counseling"},
];

const GRAMMAR = [
  {title:"~(으)ㄴ/는 것 같다 (Seems like/I think)",eng:"~(으)ㄴ/는 것 같다 (Seems like)",
   desc:"추측이나 인상을 말할 때 '~(으)ㄴ/는 것 같다'를 써요.",descEng:"Use ~(으)ㄴ/는 것 같다 to express conjecture or impression.",
   rule:"동사/형용사 + (으)ㄴ/는 것 같다",ruleEng:"Verb/Adjective + (으)ㄴ/는 것 같다",
   examples:[
    {q:"한국 음식이 어때요?",a:"매운 것 같아요.",eng:"It seems spicy.",note:"맵다+ㄴ 것 같다"},
    {q:"한국이 어때요?",a:"사람들이 친절한 것 같아요.",eng:"People seem kind.",note:"친절하다+ㄴ 것 같다"},
    {q:"한국 생활이 어때요?",a:"처음에는 힘들었지만 지금은 좋은 것 같아요.",eng:"It seems good now.",note:"좋다+ㄴ 것 같다"},
    {q:"날씨가 어때요?",a:"비가 올 것 같아요.",eng:"It seems like it will rain.",note:"오다+ㄹ 것 같다"},
    {q:"라민 씨는 어때요?",a:"한국에 적응한 것 같아요.",eng:"He seems adapted to Korea.",note:"적응하다+ㄴ 것 같다"},
   ]},
  {title:"~거든요 (Because/You see)",eng:"~거든요 (Because, you see)",
   desc:"이유를 설명할 때 '~거든요'를 써요.",descEng:"Use ~거든요 to give a reason in a casual way.",
   rule:"동사/형용사 + (으)거든요",ruleEng:"Verb/Adjective + (으)거든요",
   examples:[
    {q:"한국 음식 맛있어요?",a:"네, 맛있거든요.",eng:"Yes, it's delicious, you see.",note:"맛있다+거든요"},
    {q:"왜 매운 음식을 먹어요?",a:"한국에 있으니까 익숙해지거든요.",eng:"Because I get used to it here.",note:"익숙해지다+거든요"},
    {q:"한국 친구가 많아요?",a:"조선소에 많거든요.",eng:"There are many at the shipyard.",note:"많다+거든요"},
    {q:"대중교통이 좋아요?",a:"빠르거든요.",eng:"It's fast, you see.",note:"빠르다+거든요"},
    {q:"고향이 그리워요?",a:"가족이 있거든요.",eng:"Because my family is there.",note:"있다+거든요"},
   ]},
  {title:"~잖아요 (As you know/Isn't it)",eng:"~잖아요 (As you know)",
   desc:"상대방도 아는 것을 말할 때 '~잖아요'를 써요.",descEng:"Use ~잖아요 when referring to something the listener already knows.",
   rule:"동사/형용사 + (으)잖아요",ruleEng:"Verb/Adjective + (으)잖아요",
   examples:[
    {q:"한국 물가가 비싸요?",a:"한국은 비싼 잖아요.",eng:"Korea is expensive, as you know.",note:"비싸다+ㄴ 잖아요"},
    {q:"한국의 교통이 좋아요?",a:"대중교통이 발달했잖아요.",eng:"Public transportation is well developed, as you know.",note:"발달하다+ㄴ 잖아요"},
    {q:"문화가 다르다고 했잖아요.",a:"네, 한국 문화가 독특하잖아요.",eng:"Yes, Korean culture is unique, isn't it.",note:"독특하다+ㄴ 잖아요"},
    {q:"배달 앱이 좋다고 했어요.",a:"편하잖아요!",eng:"It's convenient, isn't it!",note:"편하다+ㄴ 잖아요"},
    {q:"조선소에 외국인 근로자가 많아요.",a:"한화오션이 국제 기업이잖아요.",eng:"Because Hanwha Ocean is an international company.",note:"국제 기업이다+ㄴ 잖아요"},
   ]},
];

const DIALOGUES = [
  {title:"한국 생활 이야기",eng:"Talking About Life in Korea",lines:[
    {sp:"쑤안",role:"배관공",text:"라민 씨, 한국 생활 어때요?",eng:"Ramin, how's life in Korea?",side:"L"},
    {sp:"라민",role:"용접공",text:"처음에는 힘들었어요. 문화가 많이 다르더라고요.",eng:"It was hard at first. The culture is very different, you know.",side:"R"},
    {sp:"쑤안",text:"그래도 지금은 괜찮아요?",eng:"But are you okay now?",side:"L"},
    {sp:"라민",text:"네, 지금은 좋은 것 같아요. 한국 음식도 맛있거든요.",eng:"Yes, it seems good now. Korean food is delicious, you see.",side:"R"},
    {sp:"쑤안",text:"매운 음식도 먹어요?",eng:"Do you eat spicy food too?",side:"L"},
    {sp:"라민",text:"네! 매운 음식을 잘 먹는 것 같아요. 동료들이 도와줘요.",eng:"Yes! I seem to eat spicy food well. My colleagues help me.",side:"R"},
    {sp:"쑤안",text:"그건 좋네요. 고향이 그리워요?",eng:"That's nice. Do you miss your hometown?",side:"L"},
    {sp:"라민",text:"가끔이요. 명절 때 특히 그리워요. 가족이 있거든요.",eng:"Sometimes. Especially during holidays. Because my family is there.",side:"R"},
  ]},
  {title:"문화 차이 이야기",eng:"Talking About Cultural Differences",lines:[
    {sp:"안젤라",role:"전기공",text:"한국과 나라의 문화가 다르지요?",eng:"Korean culture is different from our country's, right?",side:"L"},
    {sp:"준",role:"도장공",text:"네, 그래요. 근데 한국 문화를 존중하려고 노력해요.",eng:"Yes, it is. But I try to respect Korean culture.",side:"R"},
    {sp:"안젤라",text:"한국의 다문화를 어떻게 생각해요?",eng:"What do you think about Korea's multiculturalism?",side:"L"},
    {sp:"준",text:"좋은 것 같아요. 외국인과 한국인이 함께 일하잖아요.",eng:"I think it's good. Foreigners and Koreans work together, isn't it.",side:"R"},
    {sp:"안젤라",text:"정말로요? 처음에 어려웠잖아요.",eng:"Really? It was difficult at first, wasn't it.",side:"L"},
    {sp:"준",text:"맞아요. 하지만 좋은 동료들이 있거든요. 시간이 지나니까 괜찮아요.",eng:"That's right. But I have good colleagues. After some time, it's okay.",side:"R"},
  ]},
];

const QUIZ = [
  {q:"'생활'의 뜻은?",o:["life/living","food","place","work"],a:0},
  {q:"'~(으)ㄴ/는 것 같다'는 언제 써요?",o:["추측이나 인상을 말할 때","명령할 때","과거를 말할 때","약속할 때"],a:0},
  {q:"'문화 차이'의 뜻은?",o:["cultural difference","cultural exchange","cultural study","cultural product"],a:0},
  {q:"'향수병'의 뜻은?",o:["homesickness","illness","medicine","doctor"],a:0},
  {q:"'~거든요'는 언제 써요?",o:["이유를 설명할 때","미래를 말할 때","명령할 때","지시할 때"],a:0},
  {q:"'적응'의 뜻은?",o:["adaptation","learning","teaching","listening"],a:0},
  {q:"'~잖아요'는 언제 써요?",o:["상대방도 아는 것을 말할 때","모르는 것을 물을 때","가르칠 때","명령할 때"],a:0},
  {q:"'고향'의 뜻은?",o:["hometown","school","hospital","market"],a:0},
  {q:"'명절'의 뜻은?",o:["holiday/festival","business","disease","tool"],a:0},
  {q:"'다문화'의 뜻은?",o:["multicultural","monoculture","ancient culture","future culture"],a:0},
  {q:"'추석'은?",o:["Korean harvest festival","Christmas","New Year","birthday"],a:0},
  {q:"'설날'은?",o:["Lunar New Year","summer day","autumn day","winter day"],a:0},
  {q:"'외국인'의 뜻은?",o:["foreigner","Korean person","person","worker"],a:0},
  {q:"'이해하다'의 뜻은?",o:["to understand","to teach","to learn","to write"],a:0},
  {q:"'존중하다'의 뜻은?",o:["to respect","to accept","to refuse","to ignore"],a:0},
  // 글로벌 인재 & 다문화 퀴즈
  {q:"한국의 KIIP 프로그램은 뭐예요?",o:["사회통합프로그램","한국어 학원","관광 프로그램","여행 프로그램"],a:0},
  {q:"한국이 외국인 근로자를 지원하는 이유는?",o:["글로벌 인재 양성 & 다문화 포용","관광객 유치","농업 발전","해외 진출"],a:0},
  {q:"한화오션의 다문화 지원 정책은?",o:["언어 교육, 문화 프로그램, 상담 지원","무료 여행","고급 급료","빠른 승진"],a:0},
];

const CULTURE = [
  {icon:"🌍",t:"한국의 다문화 사회",eng:"Korea's Multicultural Society",d:"한국은 빠르게 다문화 사회로 변하고 있어요. 외국인 근로자가 200만 명 이상이에요. 다문화가족도 증가하고 있어요. 한국인과 외국인이 함께 일하고 살아요.",de:"Korea is rapidly becoming a multicultural society. There are over 2 million foreign workers. Multicultural families are also increasing. Koreans and foreigners work and live together."},
  {icon:"👷",t:"외국인 근로자 지원",eng:"Foreign Worker Support",d:"한국은 '고용허가제'로 외국인 근로자를 지원해요. 건강보험, 산재보험에 가입할 수 있어요. 한국어 교육도 무료로 제공해요. 상담 서비스도 있어요.",de:"Korea supports foreign workers through the 'employment permit system.' They can join health and industrial accident insurance. Free Korean language education is provided. Counseling services are available."},
  {icon:"📚",t:"KIIP 사회통합프로그램",eng:"KIIP Social Integration Program",d:"KIIP는 외국인이 한국에서 정착하도록 돕는 프로그램이에요. 한국어와 한국문화를 배워요. 취업 지원, 법률 상담도 받을 수 있어요. 전국에 100개 이상의 센터가 있어요.",de:"KIIP is a program to help foreigners settle in Korea. They learn Korean language and culture. They receive job support and legal counseling. There are over 100 centers nationwide."},
  {icon:"🤝",t:"다문화센터 & 지역사회",eng:"Multicultural Centers & Community",d:"전국의 다문화센터에서 외국인을 지원해요. 한국어 교육, 문화 체험, 취업 정보를 제공해요. 아이들을 위한 교육도 있어요. 외국인 네트워크도 만들어요.",de:"Multicultural centers nationwide support foreigners. They provide Korean language education, cultural experiences, and job information. Education for children is also available. Foreigner networks are created."},
  {icon:"🎓",t:"글로벌 인재 양성",eng:"Global Talent Development",d:"한국 기업들은 글로벌 인재를 찾아요. 외국인 근로자들의 한국어와 기술 능력을 개발하려고 해요. 직업 훈련, 언어 교육, 문화 이해 교육을 제공해요.",de:"Korean companies seek global talent. They try to develop foreign workers' Korean language and technical skills. Vocational training, language education, and cultural understanding education are provided."},
  {icon:"🏢",t:"한화오션 다문화 지원",eng:"Hanwha Ocean Multicultural Support",d:"한화오션은 외국인 근로자를 위해 다문화 프로그램을 운영해요. 한국어 교육, 문화 이해 프로그램, 상담 서비스를 제공해요. 명절 행사도 함께 해요. 글로벌 인재 양성에 힘써요.",de:"Hanwha Ocean operates multicultural programs for foreign workers. It provides Korean language education, cultural understanding programs, and counseling services. They celebrate holidays together. They work to develop global talent."},
];

const LOCAL_INFO = {
  title: "한국의 성장 원동력: 글로벌 인재 & 다문화",
  eng: "Korea's Growth Engine: Global Talent & Multiculturalism",
  facts: [
    {label:"다문화사회 Multicultural",val:"외국인 근로자 200만+ 명"},
    {label:"외국인근로자 Foreign Workers",val:"고용허가제로 지원"},
    {label:"KIIP프로그램 KIIP",val:"한국어·문화·취업 지원"},
    {label:"다문화센터 Centers",val:"전국 100+ 센터 운영"},
    {label:"글로벌인재 Talent",val:"기술·언어·문화 개발"},
    {label:"한화오션 다문화 HO",val:"교육·상담·문화 프로그램"},
    {label:"사회포용 Inclusion",val:"함께 일하고 함께 살아요"},
  ],
  desc: "한국은 글로벌 인재가 필요한 성장 국가예요! 외국인 근로자가 200만 명 이상이에요. 고용허가제로 근로자를 지원하고, KIIP 사회통합프로그램으로 한국 정착을 도와요. 다문화센터에서 한국어 교육, 취업 지원, 문화 체험을 제공해요. 한화오션도 외국인 근로자를 위해 한국어 교육, 문화 이해 프로그램, 상담 서비스를 운영해요. 함께 일하고 함께 살아가는 다문화 사회 한국!",
  descEng: "Korea is a growth nation that needs global talent! There are over 2 million foreign workers. The employment permit system supports workers, and the KIIP social integration program helps settle in Korea. Multicultural centers provide Korean language education, job support, and cultural experiences. Hanwha Ocean also operates Korean language education, cultural understanding programs, and counseling services for foreign workers. Korea is a multicultural society where we work and live together!"
};

// HANGUL DATA (Level 0 — 19과: 한글 응용 - 이메일·민원 작성)
const HANGUL_CONSONANTS = [
  {char:"보내는 사람",rom:"bo-nae-neun sa-ram",name:"Sender"},
  {char:"받는 사람",rom:"bat-neun sa-ram",name:"Recipient"},
  {char:"제목",rom:"je-mok",name:"Subject"},
  {char:"안녕하십니까",rom:"an-nyeong-ha-sim-ni-kka",name:"Hello (formal)"},
  {char:"저는",rom:"jeo-neun",name:"I (subject)"},
  {char:"요청합니다",rom:"yo-cheong-ham-ni-da",name:"I request"},
  {char:"감사합니다",rom:"gam-sa-ham-ni-da",name:"Thank you"},
  {char:"처리 부탁합니다",rom:"cheo-ri bu-tak-ham-ni-da",name:"Please process"},
  {char:"회신 부탁합니다",rom:"hoe-sin bu-tak-ham-ni-da",name:"Please reply"},
  {char:"첨부파일",rom:"cheom-bu-pa-il",name:"Attachment"},
  {char:"확인 부탁드립니다",rom:"hwa-gin bu-tak-deu-rim-ni-da",name:"Please confirm"},
  {char:"문의합니다",rom:"mun-ui-ham-ni-da",name:"I inquire"},
];
const HANGUL_VOWELS = [
  {char:"이메일 양식 Email Format",rom:"i-me-il yang-sik",name:"Email structure"},
  {char:"제목: 한국어 수료증 신청",rom:"je-mok:",name:"Subject line"},
  {char:"본문 Body",rom:"bon-mun",name:"Main text"},
  {char:"내용 Content",rom:"nae-yong",name:"Content"},
  {char:"서명 Signature",rom:"seo-myeong",name:"Signature"},
  {char:"날짜 Date",rom:"nal-jja-e",name:"Date"},
  {char:"직책 Title",rom:"jik-chaek",name:"Job title"},
  {char:"연락처 Contact",rom:"yeon-rak-cheo",name:"Contact info"},
  {char:"이메일 주소 Email address",rom:"i-me-il ju-so",name:"Email"},
  {char:"전화번호 Phone",rom:"jeon-hwa beon-ho",name:"Phone number"},
  {char:"주소 Address",rom:"ju-so",name:"Address"},
  {char:"부서 Department",rom:"bu-seo",name:"Department"},
];
const HANGUL_PRACTICE = [
  {char:"이메일 예시 Sample Email",rom:"",name:"— 예제 —"},
  {char:"보내는 사람: 라민 (라민@이메일.com)",rom:"",name:"From"},
  {char:"받는 사람: 담당자 (hanwha@ocean.com)",rom:"",name:"To"},
  {char:"제목: 한국어 수료증 신청",rom:"",name:"Subject"},
  {char:"안녕하십니까?",rom:"",name:"Greeting"},
  {char:"저는 라민이에요. 한화오션에서 일하고 있어요.",rom:"",name:"Introduction"},
  {char:"한국어 코스를 수료했으니 수료증을 신청합니다.",rom:"",name:"Request"},
  {char:"처리 부탁드립니다.",rom:"",name:"Closing"},
  {char:"감사합니다.",rom:"",name:"Thank you"},
  {char:"라민",rom:"",name:"Signature"},
  {char:"라민@이메일.com / 010-0000-0000",rom:"",name:"Contact"},
];
const SAFETY_WORDS = [
  {kor:"도움이 필요해요",eng:"I need help",rom:"do-um-i pil-yo-hae-yo"},
  {kor:"질문이 있어요",eng:"I have a question",rom:"jil-mun-i i-sseo-yo"},
  {kor:"신청하고 싶어요",eng:"I want to apply",rom:"sin-cheong-ha-go sip-eo-yo"},
  {kor:"확인해 주세요",eng:"Please confirm",rom:"hwa-gin-hae ju-se-yo"},
  {kor:"어떻게 해야 해요?",eng:"What should I do?",rom:"eo-ddeo-ke hae-ya hae-yo"},
  {kor:"알았어요",eng:"I understand",rom:"al-wa-sseo-yo"},
  {kor:"감사합니다",eng:"Thank you",rom:"gam-sa-ham-ni-da"},
  {kor:"미안합니다",eng:"I'm sorry",rom:"mi-an-ham-ni-da"},
  {kor:"다시 한 번 말씀해 주세요",eng:"Please say it again",rom:"da-si han beon mal-sseum-hae ju-se-yo"},
  {kor:"천천히 말씀해 주세요",eng:"Please speak slowly",rom:"cheon-cheon-hi mal-sseum-hae ju-se-yo"},
  {kor:"한국어로 어떻게 말해요?",eng:"How do you say it in Korean?",rom:"han-guk-eo-ro eo-ddeo-ke mal-hae-yo"},
  {kor:"무엇을 도와드릴까요?",eng:"How can I help you?",rom:"mu-eo-seul do-wa-deu-ril-kka-yo"},
];
const HANGUL_TABS = ['이메일 표현 Email','이메일 양식 Format','예시 이메일 Sample','안전·소통 Safety'];
const HANGUL_SUBTITLE = "한글 응용 · 이메일·민원 작성";

// ===== READING PASSAGES =====
const READING_PASSAGES = [
  {title:"한국 생활 적응기",eng:"Adapting to Life in Korea",
   text:"라민 씨는 한국에 온 지 1년이 됐어요.\n처음에는 문화가 많이 달라서 힘들었어요.\n한국 음식도 매워서 먹기 어려웠어요.\n하지만 지금은 많이 적응했어요.\n친구들이 도와줘서 한국어도 잘 할 수 있게 됐어요.\n한국의 대중교통도 편해요.\n편의점과 배달 앱이 정말 좋아요.\n조선소의 동료들도 좋은 사람들이예요.\n때때로 고향이 그리워요.\n하지만 한국 생활이 좋은 것 같아요.",
   textEng:"Ramin has been in Korea for 1 year now.\nAt first, the culture was very different and it was hard.\nKorean food was also spicy and difficult to eat.\nBut now she has adapted a lot.\nHer friends helped her so she can speak Korean well.\nKorea's public transportation is convenient.\nConvenience stores and delivery apps are really great.\nHer colleagues at the shipyard are good people.\nShe sometimes misses her hometown.\nBut life in Korea seems good.",
   questions:[
     {q:"라민 씨는 한국에 몇 년 있었어요?",a:"1년",ae:"1 year"},
     {q:"처음에 뭐가 힘들었어요?",a:"문화 차이, 음식",ae:"Cultural difference, food"},
     {q:"지금 한국 생활이 어떤가요?",a:"좋은 것 같아요",ae:"Seems good"},
   ]},
  {title:"한국의 다문화 지원",eng:"Korea's Multicultural Support",
   text:"한국은 다문화 사회가 되고 있어요.\n외국인 근로자가 200만 명 이상이에요.\n한국 정부는 KIIP 사회통합프로그램을 제공해요.\n프로그램에서는 한국어와 한국문화를 배워요.\n취업 지원도 받을 수 있어요.\n전국에 100개 이상의 다문화센터가 있어요.\n한화오션도 외국인 근로자를 위해 교육을 제공해요.\n한국어 교육, 문화 이해 교육, 상담 서비스가 있어요.\n한국인과 외국인이 함께 일하고 함께 살아요.\n이것이 한국의 성장 원동력이에요.",
   textEng:"Korea is becoming a multicultural society.\nThere are over 2 million foreign workers.\nThe Korean government provides the KIIP social integration program.\nIn the program, they learn Korean language and culture.\nThey can also receive job support.\nThere are over 100 multicultural centers nationwide.\nHanwha Ocean also provides education for foreign workers.\nThere is Korean language education, cultural understanding education, and counseling services.\nKoreans and foreigners work and live together.\nThis is Korea's engine for growth.",
   questions:[
     {q:"KIIP는 뭐예요?",a:"사회통합프로그램",ae:"Social integration program"},
     {q:"외국인 근로자가 몇 명이에요?",a:"200만 명 이상",ae:"Over 2 million"},
     {q:"한화오션이 외국인을 위해 뭘 제공해요?",a:"한국어 교육, 문화 이해 교육, 상담",ae:"Korean language, cultural education, counseling"},
   ]},
];

// ===== FOLKTALE DATA (춘향전 - 40 sentences) =====
const FOLKTALE = {
  title: "춘향전",
  eng: "Chunhyangjeon (The Story of Chunhyang)",
  desc: "조선시대 명기 춘향과 양반 이도령의 비극적인 사랑 이야기입니다.",
  descEng: "A tragic love story between Chunhyang, a famous courtesan, and Yi Do-ryung, a yangban (aristocrat) from the Joseon Dynasty.",
  sentences: [
    {kor:"옛날 전라도 남원에 춘향이라는 예쁜 여자가 살았어요.",eng:"Once upon a time, a beautiful woman named Chunhyang lived in Namwon, Jeolla Province."},
    {kor:"춘향의 어머니는 명기였어요.",eng:"Chunhyang's mother was a famous courtesan."},
    {kor:"춘향은 어머니를 따라 명기가 되었어요.",eng:"Chunhyang became a courtesan like her mother."},
    {kor:"어느 날, 양반 집의 아들 이도령이 남원에 왔어요.",eng:"One day, Yi Do-ryung, son of a yangban family, came to Namwon."},
    {kor:"이도령은 춘향을 봤을 때 반했어요.",eng:"Yi Do-ryung fell in love when he saw Chunhyang."},
    {kor:"춘향도 이도령을 좋아하게 됐어요.",eng:"Chunhyang also came to like Yi Do-ryung."},
    {kor:"둘은 몰래 만나서 사랑하게 됐어요.",eng:"They met secretly and fell in love."},
    {kor:"하지만 이도령의 아버지는 승진해서 한양으로 가야 했어요.",eng:"But Yi Do-ryung's father was promoted and had to move to Hanyang (Seoul)."},
    {kor:"이도령은 춘향에게 자신을 기다려달라고 했어요.",eng:"Yi Do-ryung asked Chunhyang to wait for him."},
    {kor:"이도령이 떠난 후 새로운 감사가 남원에 왔어요.",eng:"After Yi Do-ryung left, a new governor came to Namwon."},
    {kor:"감사는 춘향의 아름다움에 반했어요.",eng:"The governor was fascinated by Chunhyang's beauty."},
    {kor:"감사는 춘향에게 자신의 첩이 되라고 강요했어요.",eng:"The governor forced Chunhyang to become his concubine."},
    {kor:"춘향은 이도령을 사랑하니까 거절했어요.",eng:"Chunhyang refused because she loved Yi Do-ryung."},
    {kor:"감사는 화를 내고 춘향을 감옥에 가두었어요.",eng:"The governor was angry and imprisoned Chunhyang."},
    {kor:"감옥에서 춘향은 고문을 받았어요.",eng:"In prison, Chunhyang was tortured."},
    {kor:"하지만 춘향은 이도령에 대한 사랑을 잃지 않았어요.",eng:"But Chunhyang never lost her love for Yi Do-ryung."},
    {kor:"한편, 이도령은 과거시험에 합격했어요.",eng:"Meanwhile, Yi Do-ryung passed the civil service exam."},
    {kor:"이도령은 암행어사가 되었어요.",eng:"Yi Do-ryung became a secret royal inspector."},
    {kor:"비밀리에 남원으로 내려온 이도령은 춘향이 감옥에 있다는 것을 알았어요.",eng:"Yi Do-ryung, who came to Namwon secretly, learned that Chunhyang was in prison."},
    {kor:"이도령은 감사를 잡아서 한양으로 올라갔어요.",eng:"Yi Do-ryung captured the governor and took him to Hanyang."},
    {kor:"춘향은 감옥에서 풀려났어요.",eng:"Chunhyang was released from prison."},
    {kor:"이도령과 춘향은 서로를 다시 만났어요.",eng:"Yi Do-ryung and Chunhyang saw each other again."},
    {kor:"둘은 결혼했어요.",eng:"They got married."},
    {kor:"이들은 함께 한양으로 가서 행복하게 살았어요.",eng:"They went to Hanyang together and lived happily."},
    {kor:"이 이야기는 충청도와 전라도의 여러 판본이 있어요.",eng:"This story has several versions from different regions."},
    {kor:"춘향전은 한국의 가장 유명한 고전 문학이에요.",eng:"Chunhyangjeon is Korea's most famous classic literature."},
    {kor:"한국의 전통 공연 판소리로도 알려져 있어요.",eng:"It is also known as a traditional Korean performance called pansori."},
    {kor:"춘향의 정절(貞節)을 중요하게 생각해요.",eng:"The story emphasizes Chunhyang's chastity and fidelity."},
    {kor:"이도령의 진심을 보여주는 이야기예요.",eng:"It is a story that shows Yi Do-ryung's sincerity."},
    {kor:"어려움 속에서도 사랑을 지키는 것의 중요성을 가르쳐요.",eng:"It teaches the importance of keeping love even in hardship."},
    {kor:"한국인은 춘향이의 순절을 칭찬해요.",eng:"Koreans praise Chunhyang's loyalty."},
    {kor:"춘향과 이도령의 사랑은 영원해요.",eng:"The love between Chunhyang and Yi Do-ryung is eternal."},
    {kor:"남원에는 춘향 묘(墓)와 춘향전시관이 있어요.",eng:"In Namwon, there is Chunhyang's tomb and a Chunhyang museum."},
    {kor:"매년 춘향제가 열려요.",eng:"The Chunhyang Festival is held every year."},
    {kor:"춘향의 이야기는 영화, 뮤지컬, 드라마로 만들어졌어요.",eng:"The story of Chunhyang has been made into movies, musicals, and dramas."},
    {kor:"한국의 전통 가치를 보여주는 중요한 문화 유산이에요.",eng:"It is an important cultural heritage showing Korea's traditional values."},
    {kor:"춘향처럼 어려움 속에서도 믿음을 지켜야 해요.",eng:"Like Chunhyang, we should keep faith even in hardship."},
    {kor:"사랑하는 사람을 위해 헌신하는 것은 아름다워요.",eng:"Dedication for the one you love is beautiful."},
    {kor:"조선소에서도 서로 믿고 도와주면 좋아요.",eng:"It's good to trust and help each other at the shipyard."},
    {kor:"함께하는 시간이 가장 소중해요.",eng:"Time spent together is most precious."},
    {kor:"춘향전은 시대를 초월한 사랑의 이야기예요.",eng:"Chunhyangjeon is a timeless love story."},
  ]
};

const FOLKTALE_QUIZ = [
  {q:"춘향이는 뭐였어요?",o:["명기","양반","왕비","농민"],a:0},
  {q:"이도령은 누구의 아들이에요?",o:["양반","상인","농민","의사"],a:0},
  {q:"이도령이 한양으로 가야 한 이유는?",o:["아버지의 승진","사업","결혼","공부"],a:0},
  {q:"남원의 감사는 뭘 강요했어요?",o:["첩이 되는 것","음악을 배우는 것","춤을 배우는 것","돈을 주는 것"],a:0},
  {q:"춘향은 왜 거절했어요?",o:["이도령을 사랑했어요","두려웠어요","아팠어요","돈이 없었어요"],a:0},
  {q:"감옥에서 춘향은 뭐를 받았어요?",o:["고문","선물","음식","책"],a:0},
  {q:"이도령은 뭐가 되었어요?",o:["암행어사","의사","상인","선생님"],a:0},
  {q:"이도령은 어떻게 감사를 잡았어요?",o:["비밀리에 남원으로 내려와","전쟁을 일으켜","돈을 줘서","편지를 보내서"],a:0},
  {q:"춘향과 이도령은 어디로 갔어요?",o:["한양","부산","제주","대구"],a:0},
  {q:"춘향전은 뭐로 유명해요?",o:["고전 문학, 판소리","영화","음악","여행지"],a:0},
  {q:"남원에는 뭐가 있어요?",o:["춘향 묘, 춘향전시관","병원","학교","상점"],a:0},
  {q:"춘향제는 언제 열려요?",o:["매년","5년마다","10년마다","한 번만"],a:0},
  {q:"이 이야기의 교훈은?",o:["어려움 속에서도 믿음을 지켜야 해요","돈이 최고","혼자가 좋아요","열심히 일해야 해요"],a:0},
  {q:"춘향이의 어머니는 뭐였어요?",o:["명기","양반","왕비","농민"],a:0},
  {q:"춘향전이 만들어진 것은?",o:["영화, 뮤지컬, 드라마","책","그림","음악"],a:0},
];
...
const REVIEW_DATA = {
  preview: {
    ...
    items: [
      {label:"20과 주제",val:"꿈이 뭐예요? · What's Your Dream?",detail:"미래의 꿈과 목표를 이야기합니다."},
      {label:"핵심 어휘",val:"꿈, 목표, 계획, 성공",detail:"dream, goal, plan, success"},
      {label:"핵심 문법",val:"~고 싶어요, ~하려고, ~기 위해",detail:"want to, intend to, in order to"},
      {label:"조선소 어휘",val:"경력 개발, 승진, 기술 전수",detail:"career development, promotion, skill transfer"},
    ]
  },
  review: {
    title: "복습 · Review",
    desc: "19과에서 배운 내용을 확인하세요.",
    descEng: "Check what you learned in Lesson 19.",
    sections: [
      {title:"한국 생활 어휘",icon:"🌍",items:["생활, 적응, 문화 차이, 향수병","날씨, 음식, 교통, 친구, 동료","고향, 명절, 추석, 설날","다문화, 외국인, 이해하다, 존중하다"]},
      {title:"~(으)ㄴ/는 것 같다",icon:"💭",items:["힘든 것 같아요","좋은 것 같아요","다른 것 같아요","친절한 것 같아요"]},
      {title:"~거든요, ~잖아요",icon:"📝",items:["도와줬거든요","많거든요","발달했잖아요","국제 기업이잖아요"]},
      {title:"글로벌 인재 & 다문화",icon:"🚀",items:["외국인 근로자 200만 명","KIIP 사회통합프로그램","다문화센터 100+ 개","한화오션 다문화 지원","함께 일하고 함께 살아요","한국의 성장 원동력"]},
    ]
  },
  dictation: ["한국 생활 어때요?","처음에는 힘들었어요.","지금은 괜찮아요.","매운 음식을 잘 먹는 것 같아요.","문화가 다르거든요.","고향이 그리워요.","명절 때 특히 그래요.","한국을 존중해요.","외국인과 한국인이 함께 일해요.","한국은 성장하는 나라예요."],
};
...
function renderHome() {
  ...
  <div style="background:linear-gradient(135deg,#1E3A5F,#2E75B6);border-radius:16px;padding:20px;margin-bottom:16px;color:#fff">
    <div style="font-size:12px;color:#8899BB;margin-bottom:2px">초급 19과 · Beginner Lesson 19</div>
    ...
    <div style="font-size:26px;font-weight:800;margin-bottom:2px">한국 생활이 어때요?</div>
    <div style="font-size:13px;color:#aabbdd">How's life in Korea? — 한국 생활과 적응 · Life in Korea & Adaptation</div>
    <div style="margin-top:12px;display:flex;gap:6px;flex-wrap:wrap">
      ${['~(으)ㄴ/는 것 같다','~거든요','~잖아요','생활 표현'].map(o=>`<span style="background:rgba(255,255,255,0.12);border-radius:6px;padding:3px 10px;font-size:11px">✓ ${o}</span>`).join('')}
    </div>
  </div>
  ...
  <button onclick="setState({page:'geoje'})" class="btn btn-navy" style="margin-bottom:8px">🌍 글로벌 인재 & 다문화 보기</button>
  <button onclick="setState({page:'curriculum'})" class="btn" style="background:#e5e7eb;color:#555">📋 전체 커리큘럼 보기</button>
  <div style="display:flex;gap:8px;margin-top:12px"><a href="/HanwhaOcean_Level1_Lesson18" style="flex:1;padding:12px;border-radius:10px;background:#e5e7eb;color:#555;font-size:13px;font-weight:700;text-align:center;text-decoration:none">← 18과 공문서 읽기</a><a href="/HanwhaOcean_Level1_Lesson20" style="flex:1;padding:12px;border-radius:10px;background:var(--ocean);color:#fff;font-size:13px;font-weight:700;text-align:center;text-decoration:none">20과 꿈이 뭐예요? →</a></div>`;
}
...
function renderCurriculum() {
  ...
  ${levels.map(lv=>`<div class="card" style="border-left:4px solid ${lv.c}">
    ...
    <div class="progress"><div class="progress-bar" style="width:${lv.id<=1?(lv.id===1?'95%':'0%'):'0%'};background:${lv.c}"></div></div>
  </div>`).join('')}`;
}
...
function renderHangul() {
  ...
  const progressPct = 95;
  const progressLabel = "19/20";
...
function renderVocab() {
  const tabs = ['한국 생활 Life in Korea','조선소 Shipyard','일상 어휘 Daily Vocabulary','도구·장비 Tools&Equip'];
  const t = state.vocabTab;
  let content = '';
  if (t===0) content = VOCAB_LIFE.map((v,i)=>`
  ...
  else if (t===2) content = `<div class="grid2">${VOCAB_DAILY.map(v=>`
  ...
  return `<h2>📖 어휘 · Vocabulary</h2><p class="sub">19과 핵심 어휘 (${VOCAB_LIFE.length+VOCAB_SHIPYARD.length+VOCAB_DAILY.length+VOCAB_SHIPYARD_NOUNS.length}단어)</p>
...
function renderGrammar() {
  ...
  return `<h2>✏️ 문법 · Grammar</h2><p class="sub">19과 핵심 문법 ${GRAMMAR.length}개</p>
...
${state.wrCountry?'한국 생활은 '+state.wrCountry+'어요.':''}
${state.wrJob?state.wrJob+' 것 같아요.':''}
${state.wrExtra?state.wrExtra:''}
함께해요!` : '';

  return `<h2><span class="section-icon">✍️</span>쓰기 · Writing</h2><p class="sub">나의 한국 생활 · Describe My Life in Korea</p>
  <div class="card" style="background:#fff7ed;border:2px solid var(--orange)">
    <b style="color:var(--orange)">📋 한국 생활을 소개해 보세요 · Describe your life in Korea</b>
  </div>
  <div style="margin-top:12px">
    ...
    <label style="font-size:13px;font-weight:700;color:var(--navy)">한국 생활이 어때요? How's life in Korea?</label>
    <input class="input" placeholder="예: 좋아요 / 힘들어요 / 재미있어요" value="${state.wrCountry}" oninput="state.wrCountry=this.value;render()">
    <label style="font-size:13px;font-weight:700;color:var(--navy)">뭐가 좋거나 힘들어요? What's good or hard?</label>
    <input class="input" placeholder="예: 음식이 맛있어 / 친구가 생겨 / 문화가 달라" value="${state.wrJob}" oninput="state.wrJob=this.value;render()">
    <label style="font-size:13px;font-weight:700;color:var(--navy)">더 쓰고 싶은 말 More to say</label>
    <input class="input" placeholder="예: 한국인을 이해하려고 노력해요!" value="${state.wrExtra}" oninput="state.wrExtra=this.value;render()">
  </div>
  ${preview?`
  ...
  `:'<div style="color:#ccc;text-align:center;margin:30px 0">위에 정보를 입력하면 나의 한국 생활 소개가 만들어집니다.<br>Fill in the fields above to generate your life description.</div>'}

  <div style="margin-top:20px;font-weight:700;color:var(--navy);margin-bottom:8px">✍️ 자유 쓰기 · Free Writing</div>
  <textarea placeholder="자유롭게 한국어로 써 보세요.&#10;Write freely in Korean.&#10;&#10;예: 한국 생활이 좋은 것 같아요.&#10;처음에는 힘들었지만 지금은 적응했어요.&#10;한국인을 존중해요."></textarea>`;
}

function renderFlashcard() {
  const all = [...VOCAB_LIFE.map(v=>({f:v.kor,b:v.eng})),...VOCAB_DAILY.map(v=>({f:v.kor,b:v.eng})),...VOCAB_SHIPYARD_NOUNS.map(v=>({f:v.kor,b:v.eng}))];
...
function renderCulture() {
  return `<h2>🏛️ 문화와 정보 · Culture & Info</h2><p class="sub">한국의 다문화 문화 · Korean Multicultural Culture</p>
  ...
  <button onclick="setState({page:'geoje'})" class="btn btn-navy" style="margin-top:10px">🌍 글로벌 인재 & 다문화 보기</button>`;
}
...
function renderReview() {
  ...
  if (t===0) { // 복습
    ...
    <button onclick="TTS.speak('${rv.sections[0].items.join('. ')}')" class="btn btn-primary" style="margin-top:8px">🔊 핵심 생활 표현 전체 듣기</button>`;
  }
  if (t===1) { // 예습
    ...
    <div class="card" style="background:linear-gradient(135deg,#f0f7ff,#fff7ed);border:2px solid var(--ocean)">
      ...
      <div style="font-size:12px;color:#888;margin-bottom:12px">19과를 미리 살펴보세요!</div>
    </div>
    ${pv.items.map((item,i)=>`
    ...
    <div class="card card-green" style="background:var(--light-green)">
      ...
      <div style="font-size:13px;color:#333;line-height:1.6">
        1. 한국 생활 관련 어휘를 미리 읽어 보세요.<br>
        2. 한국 생활의 어려움과 장점을 생각해 보세요.<br>
        3. 한국의 다문화 사회를 알아보세요.
      </div>
      <div style="font-size:12px;color:#888;margin-top:6px;line-height:1.5">
        1. Read life-related vocabulary in advance.<br>
        2. Think about challenges and advantages of life in Korea.<br>
        3. Learn about Korea's multicultural society.
      </div>
    </div>`;
  }
  // t===2: 받아쓰기
...
function renderGeoje() {
  ...
  <div class="card" style="background:var(--light-orange);border:2px solid var(--orange)">
    <b style="color:var(--orange)">🚀 한국의 성장 원동력: 글로벌 인재 & 다문화 Global Talent & Multicultural</b>
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:8px">
      ${[
        {item:'다문화사회',price:'외국인 200만+',emoji:'🌍',eng:'Multicultural'},
        {item:'외국인근로자',price:'고용허가제',emoji:'👷',eng:'Foreign Workers'},
        {item:'KIIP프로그램',price:'한국어·문화·취업',emoji:'📚',eng:'KIIP Program'},
        {item:'다문화센터',price:'100+ 센터',emoji:'🤝',eng:'Multicultural Centers'},
        {item:'글로벌인재',price:'기술·언어·문화',emoji:'🎓',eng:'Global Talent'},
        {item:'한화오션 다문화',price:'교육·상담·문화',emoji:'🏢',eng:'HO Multicultural'},
      ].map(p=>`
...
// ===== AI 에이전트 (조선소 특화) =====
var AI_QUICK_BTNS = [
  {emoji:'🙇',label:'한국 기본 예절',
   q:'한국예절 korean manner 기본예절 예의를 알려주세요' },
  {emoji:'🍽️',label:'식사 예절',
   q:'식사예절 dining manner 밥먹을때 식탁예절을 알려주세요' },
  {emoji:'🎊',label:'명절/공휴일',
   q:'명절휴일 holiday festival 추석설날 공휴일을 알려주세요' },
  {emoji:'🏢',label:'직장 문화',
   q:'직장문화 workplace culture 한국직장 회사문화를 알려주세요' },
  {emoji:'💡',label:'한국 생활 팁',
   q:'한국생활팁 korean life tip 한국에서생활 생활팁을 알려주세요' }
];
var AICHAT = {
  msgs: [],
  loading: false,
  ...
  send: async function(text, label) {
    ...
    try {
      var sysP = 'You are a Korean daily life adaptation coach for foreign workers in Korea. Lesson focus: daily life vocab 생활(daily life), 문화(culture), 적응(adaptation), life skill words, seeming/guessing expression ~(으)ㄴ/는 것 같다, useful resources like 다누리 콜센터. SHORT answers with English. LESSON:L1L19';
      var url = '/api/chat';
...
function renderAI() {
  ...
  <div style="background:linear-gradient(135deg,#1E3A5F,#2E75B6);color:#fff;border-radius:12px;padding:16px;margin-bottom:12px">
    ...
    <div style="font-size:15px;font-weight:800;margin-bottom:6px">🌏 AI 한국 생활 가이드</div>
    <div style="font-size:11px;opacity:0.85;line-height:1.7">문화 적응 · 생활 팁 · 외국인 지원<br>
    <span style="color:#93c5fd">🔵 Korea Life Guide × Daily Life Korean</span></div>
  </div>
    ...
    <details style="margin-bottom:8px">
      ...
      <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:0 0 8px 8px;padding:12px;font-size:12px;line-height:1.9;color:#1a202c">
        ...
        <div style="background:#fff;border-radius:6px;padding:8px;margin:4px 0;border-left:3px solid #2563eb">
          ...
          <span style="font-family:monospace;background:#dbeafe;padding:4px 8px;border-radius:4px;display:block;margin:4px 0;font-size:11px;line-height:1.6">"저는 한화오션 조선소 외국인 근로자예요. 한국 생활에 적응하는 데 필요한 한국어 표현과 문화 팁을 알고 싶어요. 외국인 지원 서비스와 일상생활 표현을 영어로도 설명해 주세요."</span>
