...
var AI_QUICK_BTNS = [
  ...
  send: async function(text, label) {
    ...
    try {
      var sysP = 'You are a Korean daily life adaptation coach for foreign workers in Korea. Lesson focus: daily life vocab 생활(daily life), 문화(culture), 적응(adaptation), life skill words, seeming/guessing expression ~(으)ㄴ/는 것 같다, useful resources like 다누리 콜센터. SHORT answers with English.
LESSON:L1L19';
      var url = '/api/chat';
